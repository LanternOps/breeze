...
```bash
ssh root@164.90.237.99 "PGPASSWORD='<DB_PASSWORD>' psql 'postgresql://doadmin@private-breeze-eu-db-do-user-227115-0.i.db.ondigitalocean.com:25060/breeze?sslmode=require' -c \"
