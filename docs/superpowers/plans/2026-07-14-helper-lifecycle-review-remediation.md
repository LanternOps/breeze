...
Phase 2 is **already fully planned** in `docs/superpowers/plans/2026-07-14-windows-watchdog-verified-recovery.md` — 5 tasks, 25 steps, complete with code and test names. It is entirely unstarted: `agent/internal/watchdog` and `agent/cmd/breeze-watchdog` are byte-identical to `main`.
