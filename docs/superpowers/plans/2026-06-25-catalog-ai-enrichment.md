...
**Tech Stack:** Hono + Zod (API), `@anthropic-ai/sdk` 0.105 (one-shot `messages.create`), Drizzle/Postgres, React + Vitest/jsdom (web). Spec: `docs/superpowers/specs/2026-06-25-catalog-ai-enrichment-design.md`.
