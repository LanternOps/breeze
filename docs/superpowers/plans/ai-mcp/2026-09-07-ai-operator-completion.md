...
| [#4178 Anomaly trigger](https://github.com/LanternOps/breeze/issues/4178) | Reconcile existing work in P3-0 | Spec/code indicate the trigger already exists; verify coverage before closing stale tracking |
...
| [#4181 Raw input redaction](https://github.com/LanternOps/breeze/issues/4181) | P3-0/P3-5 prerequisite for richer trace | Safe DTO/export contract; no raw input copied into task history |
...
| [#4206 Policy-action watches](https://github.com/LanternOps/breeze/issues/4206) | Reconcile existing work in P3-0/P3-4 | The Phase 2 spec says P2-5 "closes #4206", yet the issue is still open on 2026-09-07; verify intent-anchored watches end to end and close or re-scope, no duplicate implementation |
...
- [ ] Inventory legacy trigger/scheduler admission owners and define one durable occurrence identity for cutover to task workflows; list every legacy path the §6.4 sunset contract test will enumerate.
