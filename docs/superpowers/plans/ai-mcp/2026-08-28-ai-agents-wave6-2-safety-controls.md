...
- [ ] TDD (eligibility matrix incl. policy-decided exclusion, dismissed→cancelled, flap→recurred, 24h→inconclusive, notification dedupe, jobId idempotency) → commit: `feat(api): fix-held watch — recovery-anchored recurrence checks (#3828)`
