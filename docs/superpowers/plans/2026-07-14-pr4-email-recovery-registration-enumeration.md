...
**Scope:** SR2-17, SR2-18, SR2-21, SR2-22, SR2-23 from `docs/superpowers/specs/2026-07-11-core-authentication-hardening-design.md`, plus three carry-forward items deliberately deferred out of PR 3 to keep it SSO-scoped.
...
Implements PR 4 of the core-authentication hardening design (docs/superpowers/specs/2026-07-11-core-authentication-hardening-design.md). Builds on PR 1 (#2378), PR 2 (#2385) and PR 3 (#2492).
