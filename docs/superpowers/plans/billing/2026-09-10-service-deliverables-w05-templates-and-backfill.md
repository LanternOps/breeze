...
| Path | Responsibility |
|---|---|
| `apps/api/migrations/2026-10-16-100500-deliverable-templates.sql` | two tables, XOR checks, branch FKs, dual-axis RLS + partner-wide SELECT branch |
...
**Files:**
- Create: `apps/api/migrations/2026-10-16-100500-deliverable-templates.sql`
...
```bash
git add apps/api/migrations/2026-10-16-100500-deliverable-templates.sql
...
```ts
  ...
  // Created dual-axis from day one in 2026-10-16-100500-deliverable-templates.
