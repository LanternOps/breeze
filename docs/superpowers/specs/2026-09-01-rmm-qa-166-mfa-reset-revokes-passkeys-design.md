...
The continuation round brings the existing branch onto main `686a4f6a75a3d0f90baa587910dc4b39b66e1588`. The original decisions below remain historical design context; these corrections supersede their conflicting assumptions and the original no-change-to-`mfaAssurance` boundary.
