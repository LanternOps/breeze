...
**2. Do manual assets count toward device-set billing contract lines?**
...
**3. Is `site_id` required or optional?**
...
**5. Can a manual asset be "converted" into an agent device?**
...
**7. Assigned user: a Breeze `users` row or an org contact?**
