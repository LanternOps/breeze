...
| C1 cancel mid-upload | LNX-QEMU | 0.112.1 | — | NOT EXERCISED — with dedupe working the 30 MB delta finished before the 1 s probe could cancel; retry with a ≥1 GiB delta pending | `runs/lnx/postfix-C1-*.json` (absent) |
