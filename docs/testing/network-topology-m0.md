...
1. `2026-10-17-094200-topology-inventory-fk-targets.sql`
2. `2026-10-17-094300-topology-foundation.sql`
3. `2026-10-17-094400-topology-legacy-capture.sql`
4. `2026-10-17-094500-topology-inventory-lifecycle.sql`

These names follow the newest committed migration at implementation time,
`2026-10-17-094100-m365-signin-events.sql`. When adding a future migration,
