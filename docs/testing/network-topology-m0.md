...
1. `2026-10-17-130000-topology-inventory-fk-targets.sql`
2. `2026-10-17-130100-topology-foundation.sql`
3. `2026-10-17-130200-topology-legacy-capture.sql`
4. `2026-10-17-130300-topology-inventory-lifecycle.sql`
