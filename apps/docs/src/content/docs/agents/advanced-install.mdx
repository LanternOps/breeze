...
description: Alternate, scripted, and unattended ways to install the Breeze agent — ZIP bundles, MSI properties, direct binary + enroll, and the full enroll/service flag reference.
sidebar:
  order: 1.5
