...
description: Restore a full system image to bare hardware or a replacement device with the Breeze recovery environment, recovery token generation, and token security.
sidebar:
  order: 12
