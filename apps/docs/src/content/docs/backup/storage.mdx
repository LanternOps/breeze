...
description: Set up backup storage targets for S3, Azure Blob, Google Cloud, Backblaze B2, or local NAS, with connectivity testing and multiple configurations.
sidebar:
  order: 2
