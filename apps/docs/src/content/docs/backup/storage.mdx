...
4. **Configure retention.** Choose a preset or customize:
   ...
   <Aside type="note" title="What retention removes today">
     ...
     Deleting a device or an organization also reclaims its backups: the underlying restore points are
     removed immediately, and the storage sweep collects their now-unreferenced data once it has sat
     idle for the same 9-day window used for unfinished uploads.
   </Aside>
</Steps>
