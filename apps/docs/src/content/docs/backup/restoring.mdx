...
description: Restore files, folders, or full systems from Breeze backup snapshots. Covers browsing snapshots, full and selective restores, and bare metal recovery.
sidebar:
  order: 5
