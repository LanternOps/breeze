...
After you start a restore, the job appears in the backup job list with a progress indicator (0–100%). You can track it from:

- The **Backup** dashboard's Recent Jobs section
- The target device's **Backup** tab

The restore job shows bytes restored, files restored, and an estimated completion time.
