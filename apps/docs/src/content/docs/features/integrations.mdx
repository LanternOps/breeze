...
| **Pause observations** | Stop recording new Pax8 quantity observations while keeping the link intact | No |
| **Resume observations** | Resume recording Pax8 quantity observations and surfacing drift | No |
