...
|--------|-------------|:------------:|
| **Link** | Connect the subscription to an existing contract line, or create a new manual line on the spot | Yes |
| **Change** | Re-point the subscription to a different contract line | Yes |
| **Pause** | Stop automatic quantity sync while keeping the link intact | No |
| **Resume** | Re-enable automatic quantity sync | No |
