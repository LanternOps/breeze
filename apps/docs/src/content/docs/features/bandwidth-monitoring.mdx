...
description: Per-interface network bandwidth tracking with historical data, utilization metrics, and throughput analysis.
sidebar:
  order: 39
...
Bandwidth alerts can trigger [Playbooks](/features/playbooks/) for automated remediation. For example, a playbook could:
