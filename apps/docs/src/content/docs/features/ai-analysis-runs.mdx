...
Open the run, find the file, and choose **Attach to a ticket**. Breeze copies the file into a ticket attachment and adds an internal comment. The success message appears after both steps complete.
