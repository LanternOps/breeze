...
- Open **Monitoring → AI Risk Engine → Approval History** and find the executed reset. A **Reveal temporary password** button appears on it.
- Only the technician who **requested** the reset can reveal it, and it can be revealed **exactly once** -- copy it when it is shown, because it will not be shown again.
