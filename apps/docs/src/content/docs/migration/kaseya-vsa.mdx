...
| Kaseya VSA | Breeze |
|---|---|
| Monitor Sets (counter/service/process) | [Monitors](/features/monitors/) with [Delivery](/features/notifications/) |
| Event Log Sets | [Event log monitors](/features/monitors/) for conditions; [forwarding](/features/event-log-forwarding/) for external log delivery |
| Alarms → tickets | Configure the supported alert integration in your [PSA integration](/features/psa-integrations/) |
