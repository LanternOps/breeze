...
Rebuild Datto conditions as Breeze [monitors](/features/monitors/). Each monitor carries its condition, responses and delivery settings; attach it to a configuration policy to choose the devices it reaches.
