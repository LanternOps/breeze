...
| `Create-Syncro-Ticket` | Connect [Breeze ticketing](/features/ticketing/) or a [PSA integration](/features/psa-integrations/) and configure its supported alert integration |
...
|---|---|
| Monitoring / thresholds | [Monitors](/features/monitors/) with [Delivery](/features/notifications/) |
