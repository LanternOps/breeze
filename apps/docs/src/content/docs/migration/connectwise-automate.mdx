...
- **Internal monitors** are SQL queries against the Automate database. They have no meaning outside Automate. Re-express the *intent* as Breeze [monitors](/features/monitors/) with [Delivery](/features/notifications/).
