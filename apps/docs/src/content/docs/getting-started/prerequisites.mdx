---
title: Prerequisites
description: System requirements and tools needed to run Breeze RMM.
sidebar:
  order: 2
  label: Prerequisites
---
...
| **3478** | TCP/UDP | TURN server (coturn — WebRTC signaling and relay) |
| **49152–65535** | UDP | TURN media relay port range (coturn) |
