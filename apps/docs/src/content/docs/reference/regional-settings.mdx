...
| **Language** | **English** (`en`), **Português (Brasil)** (`pt-BR`), **Español (Latinoamérica)** (`es-419`), **Français (France)** (`fr-FR`), **Français (Canada)** (`fr-CA`), **Deutsch (Deutschland)** (`de-DE`), or **Italiano (Italia)** (`it-IT`) | `en` | The console display language. |
