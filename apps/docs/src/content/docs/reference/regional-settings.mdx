...
<Aside type="note">
  Brazilian Portuguese (`pt-BR`) is the one non-English locale currently shipped. Additional languages are a work in progress — the console falls back to English for any string not yet translated.
</Aside>
