...
| **Language** | **English** (`en`), **Português (Brasil)** (`pt-BR`), **Español (Latinoamérica)** (`es-419`), **Français (France)** (`fr-FR`), **Français (Canada)** (`fr-CA`), or **Deutsch (Deutschland)** (`de-DE`) | `en` | The console display language. |
