...
| `topology` | Network topology view and saved layout (`read`, `write`); running topology diagnostics and arming scheduled topology checks (`execute`) |
...
| `TOPOLOGY_EXECUTE` | `topology` | `execute` |
