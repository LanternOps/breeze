...
| Windows PowerShell one-liner | `Breeze: this machine rejected the TLS certificate of …`. Older copies of the one-liner show `Could not establish trust relationship for the SSL/TLS secure channel` instead |
