...
When you download a pre-configured MSI installer from the dashboard or a public installer link, Breeze can automatically code-sign the installer before delivery. This ensures that the patched MSI — which contains your enrollment key and site assignment — is trusted by Windows SmartScreen and antivirus tools.
