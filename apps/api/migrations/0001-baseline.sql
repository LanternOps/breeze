-- 0001-baseline.sql
-- Full Breeze RMM schema baseline.
-- Generated from pg_dump of a fresh database with all migrations applied.
-- This file is fully idempotent and safe to re-run.
...
DO $$ BEGIN CREATE TYPE public.access_review_decision AS ENUM (
    'pending',
    'approved',
    'revoked'
...
DO $$ BEGIN CREATE TYPE public.access_review_status AS ENUM (
    'pending',
    'in_progress',
    'completed'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.actor_type AS ENUM (
    'user',
    'api_key',
    'agent',
    'system'
...
DO $$ BEGIN CREATE TYPE public.agent_log_level AS ENUM (
    'debug',
    'info',
    'warn',
    'error'
...
DO $$ BEGIN CREATE TYPE public.ai_approval_mode AS ENUM (
    'per_step',
    'action_plan',
    'auto_approve',
    'hybrid_plan'
...
DO $$ BEGIN CREATE TYPE public.ai_message_role AS ENUM (
    'user',
    'assistant',
    'system',
    'tool_use',
...
DO $$ BEGIN CREATE TYPE public.ai_plan_status AS ENUM (
    'pending',
    'approved',
    'rejected',
    'executing',
...
DO $$ BEGIN CREATE TYPE public.ai_session_status AS ENUM (
    'active',
    'closed',
    'expired'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.ai_tool_status AS ENUM (
    'pending',
    'approved',
    'executing',
    'completed',
...
DO $$ BEGIN CREATE TYPE public.alert_status AS ENUM (
    'active',
    'acknowledged',
    'resolved',
    'suppressed'
...
DO $$ BEGIN CREATE TYPE public.api_key_status AS ENUM (
    'active',
    'revoked',
    'expired'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.audit_result AS ENUM (
    'success',
    'failure',
    'denied'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.automation_on_failure AS ENUM (
    'stop',
    'continue',
    'notify'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.automation_run_status AS ENUM (
    'running',
    'completed',
    'failed',
    'partial'
...
DO $$ BEGIN CREATE TYPE public.automation_trigger_type AS ENUM (
    'schedule',
    'event',
    'webhook',
    'manual'
...
DO $$ BEGIN CREATE TYPE public.backup_job_type AS ENUM (
    'scheduled',
    'manual',
    'incremental'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.backup_provider AS ENUM (
    'local',
    's3',
    'azure_blob',
    'google_cloud',
...
DO $$ BEGIN CREATE TYPE public.backup_status AS ENUM (
    'pending',
    'running',
    'completed',
    'failed',
...
DO $$ BEGIN CREATE TYPE public.backup_type AS ENUM (
    'file',
    'system_image',
    'database',
    'application'
...
DO $$ BEGIN CREATE TYPE public.brain_context_type AS ENUM (
    'issue',
    'quirk',
    'followup',
    'preference'
...
DO $$ BEGIN CREATE TYPE public.change_action AS ENUM (
    'added',
    'removed',
    'modified',
    'updated'
...
DO $$ BEGIN CREATE TYPE public.change_type AS ENUM (
    'software',
    'service',
    'startup',
    'network',
...
DO $$ BEGIN CREATE TYPE public.check_result_status AS ENUM (
    'running',
    'stopped',
    'not_found',
    'error'
...
--
-- Name: cis_baseline_level; Type: TYPE; Schema: public; Owner: -
--

DO $$ BEGIN CREATE TYPE public.cis_baseline_level AS ENUM (
    'l1',
    'l2',
    'custom'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
--
-- Name: cis_check_severity; Type: TYPE; Schema: public; Owner: -
--

DO $$ BEGIN CREATE TYPE public.cis_check_severity AS ENUM (
    'low',
    'medium',
    'high',
    'critical'
...
--
-- Name: cis_check_status; Type: TYPE; Schema: public; Owner: -
--

DO $$ BEGIN CREATE TYPE public.cis_check_status AS ENUM (
    'pass',
    'fail',
    'not_applicable',
    'error'
...
--
-- Name: cis_os_type; Type: TYPE; Schema: public; Owner: -
--

DO $$ BEGIN CREATE TYPE public.cis_os_type AS ENUM (
    'windows',
    'macos',
    'linux'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
--
-- Name: cis_remediation_approval_status; Type: TYPE; Schema: public; Owner: -
--

DO $$ BEGIN CREATE TYPE public.cis_remediation_approval_status AS ENUM (
    'pending',
    'approved',
    'rejected'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
--
-- Name: cis_remediation_status; Type: TYPE; Schema: public; Owner: -
--

DO $$ BEGIN CREATE TYPE public.cis_remediation_status AS ENUM (
    'pending_approval',
    'queued',
    'in_progress',
    'completed',
...
DO $$ BEGIN CREATE TYPE public.compliance_status AS ENUM (
    'compliant',
    'non_compliant',
    'pending',
    'error'
...
DO $$ BEGIN CREATE TYPE public.config_assignment_level AS ENUM (
    'partner',
    'organization',
    'site',
    'device_group',
...
DO $$ BEGIN CREATE TYPE public.config_feature_type AS ENUM (
    'patch',
    'alert_rule',
    'backup',
    'security',
...
DO $$ BEGIN CREATE TYPE public.config_policy_status AS ENUM (
    'active',
    'inactive',
    'archived'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.connection_protocol AS ENUM (
    'tcp',
    'tcp6',
    'udp',
    'udp6'
...
DO $$ BEGIN CREATE TYPE public.deployment_device_status AS ENUM (
    'pending',
    'running',
    'completed',
    'failed',
...
DO $$ BEGIN CREATE TYPE public.deployment_status AS ENUM (
    'draft',
    'pending',
    'running',
    'paused',
...
DO $$ BEGIN CREATE TYPE public.device_group_type AS ENUM (
    'static',
    'dynamic'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.device_patch_status AS ENUM (
    'pending',
    'installed',
    'failed',
    'skipped',
...
DO $$ BEGIN CREATE TYPE public.device_platform AS ENUM (
    'ios',
    'android'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.device_session_activity_state AS ENUM (
    'active',
    'idle',
    'locked',
    'away',
...
DO $$ BEGIN CREATE TYPE public.device_session_type AS ENUM (
    'console',
    'rdp',
    'ssh',
    'other'
...
DO $$ BEGIN CREATE TYPE public.device_status AS ENUM (
    'online',
    'offline',
    'maintenance',
    'decommissioned',
...
DO $$ BEGIN CREATE TYPE public.discovered_asset_approval_status AS ENUM (
    'pending',
    'approved',
    'dismissed'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.discovered_asset_type AS ENUM (
    'workstation',
    'server',
    'printer',
    'router',
...
DO $$ BEGIN CREATE TYPE public.discovery_job_status AS ENUM (
    'scheduled',
    'running',
    'completed',
    'failed',
...
DO $$ BEGIN CREATE TYPE public.dns_action AS ENUM (
    'allowed',
    'blocked',
    'redirected'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.dns_policy_sync_status AS ENUM (
    'pending',
    'synced',
    'error'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.dns_policy_type AS ENUM (
    'blocklist',
    'allowlist'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.dns_provider AS ENUM (
    'umbrella',
    'cloudflare',
    'dnsfilter',
    'pihole',
...
DO $$ BEGIN CREATE TYPE public.dns_threat_category AS ENUM (
    'malware',
    'phishing',
    'botnet',
    'cryptomining',
...
DO $$ BEGIN CREATE TYPE public.event_bus_priority AS ENUM (
    'low',
    'normal',
    'high',
    'critical'
...
DO $$ BEGIN CREATE TYPE public.event_log_category AS ENUM (
    'security',
    'hardware',
    'application',
    'system'
...
DO $$ BEGIN CREATE TYPE public.event_log_level AS ENUM (
    'info',
    'warning',
    'error',
    'critical'
...
DO $$ BEGIN CREATE TYPE public.execution_status AS ENUM (
    'pending',
    'queued',
    'running',
    'completed',
...
DO $$ BEGIN CREATE TYPE public.file_transfer_direction AS ENUM (
    'upload',
    'download'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.file_transfer_status AS ENUM (
    'pending',
    'transferring',
    'completed',
    'failed'
...
DO $$ BEGIN CREATE TYPE public.filesystem_cleanup_run_status AS ENUM (
    'previewed',
    'executed',
    'failed'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.filesystem_snapshot_trigger AS ENUM (
    'on_demand',
    'threshold'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.group_membership_log_action AS ENUM (
    'added',
    'removed'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.group_membership_log_reason AS ENUM (
    'manual',
    'filter_match',
    'filter_unmatch',
    'pinned',
...
DO $$ BEGIN CREATE TYPE public.initiated_by_type AS ENUM (
    'manual',
    'ai',
    'automation',
    'policy',
...
DO $$ BEGIN CREATE TYPE public.ip_assignment_type AS ENUM (
    'dhcp',
    'static',
    'vpn',
    'link-local',
...
DO $$ BEGIN CREATE TYPE public.log_correlation_severity AS ENUM (
    'info',
    'warning',
    'error',
    'critical'
...
DO $$ BEGIN CREATE TYPE public.log_correlation_status AS ENUM (
    'active',
    'resolved',
    'ignored'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.maintenance_recurrence AS ENUM (
    'once',
    'daily',
    'weekly',
    'monthly',
...
DO $$ BEGIN CREATE TYPE public.maintenance_window_status AS ENUM (
    'scheduled',
    'active',
    'completed',
    'cancelled'
...
DO $$ BEGIN CREATE TYPE public.membership_source AS ENUM (
    'manual',
    'dynamic_rule',
    'policy'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.mfa_method AS ENUM (
    'totp',
    'sms'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.monitor_status AS ENUM (
    'online',
    'offline',
    'degraded',
    'unknown'
...
DO $$ BEGIN CREATE TYPE public.monitor_type AS ENUM (
    'icmp_ping',
    'tcp_port',
    'http_check',
    'dns_check'
...
DO $$ BEGIN CREATE TYPE public.monitoring_watch_type AS ENUM (
    'service',
    'process'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.network_event_type AS ENUM (
    'new_device',
    'device_disappeared',
    'device_changed',
    'rogue_device'
...
DO $$ BEGIN CREATE TYPE public.notification_channel_type AS ENUM (
    'email',
    'slack',
    'teams',
    'webhook',
...
DO $$ BEGIN CREATE TYPE public.notification_priority AS ENUM (
    'low',
    'normal',
    'high',
    'urgent'
...
DO $$ BEGIN CREATE TYPE public.org_access AS ENUM (
    'all',
    'selected',
    'none'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.org_status AS ENUM (
    'active',
    'suspended',
    'trial',
    'churned'
...
DO $$ BEGIN CREATE TYPE public.org_type AS ENUM (
    'customer',
    'internal'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.os_type AS ENUM (
    'windows',
    'macos',
    'linux'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.partner_status AS ENUM (
    'pending',
    'active',
    'suspended',
    'churned'
...
DO $$ BEGIN CREATE TYPE public.partner_type AS ENUM (
    'msp',
    'enterprise',
    'internal'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.patch_approval_status AS ENUM (
    'pending',
    'approved',
    'rejected',
    'deferred'
...
DO $$ BEGIN CREATE TYPE public.patch_compliance_report_format AS ENUM (
    'csv',
    'pdf'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.patch_compliance_report_status AS ENUM (
    'pending',
    'running',
    'completed',
    'failed'
...
DO $$ BEGIN CREATE TYPE public.patch_job_result_status AS ENUM (
    'pending',
    'running',
    'completed',
    'failed',
...
DO $$ BEGIN CREATE TYPE public.patch_job_status AS ENUM (
    'scheduled',
    'running',
    'completed',
    'failed',
...
DO $$ BEGIN CREATE TYPE public.patch_rollback_status AS ENUM (
    'pending',
    'running',
    'completed',
    'failed',
...
DO $$ BEGIN CREATE TYPE public.patch_severity AS ENUM (
    'critical',
    'important',
    'moderate',
    'low',
...
DO $$ BEGIN CREATE TYPE public.patch_source AS ENUM (
    'microsoft',
    'apple',
    'linux',
    'third_party',
...
DO $$ BEGIN CREATE TYPE public.peripheral_device_class AS ENUM (
    'storage',
    'all_usb',
    'bluetooth',
    'thunderbolt'
...
DO $$ BEGIN CREATE TYPE public.peripheral_event_type AS ENUM (
    'connected',
    'disconnected',
    'blocked',
    'mounted_read_only',
...
DO $$ BEGIN CREATE TYPE public.peripheral_policy_action AS ENUM (
    'allow',
    'block',
    'read_only',
    'alert'
...
DO $$ BEGIN CREATE TYPE public.peripheral_policy_target_type AS ENUM (
    'organization',
    'site',
    'group',
    'device'
...
DO $$ BEGIN CREATE TYPE public.playbook_execution_status AS ENUM (
    'pending',
    'running',
    'waiting',
    'completed',
...
DO $$ BEGIN CREATE TYPE public.playbook_step_type AS ENUM (
    'diagnose',
    'act',
    'wait',
    'verify',
...
DO $$ BEGIN CREATE TYPE public.plugin_install_status AS ENUM (
    'available',
    'installing',
    'installed',
    'updating',
...
DO $$ BEGIN CREATE TYPE public.plugin_status AS ENUM (
    'active',
    'disabled',
    'error',
    'installing'
...
DO $$ BEGIN CREATE TYPE public.plugin_type AS ENUM (
    'integration',
    'automation',
    'reporting',
    'collector',
...
DO $$ BEGIN CREATE TYPE public.policy_enforcement AS ENUM (
    'monitor',
    'warn',
    'enforce'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.psa_provider AS ENUM (
    'connectwise',
    'autotask',
    'halo',
    'syncro',
...
DO $$ BEGIN CREATE TYPE public.remote_session_status AS ENUM (
    'pending',
    'connecting',
    'active',
    'disconnected',
...
DO $$ BEGIN CREATE TYPE public.remote_session_type AS ENUM (
    'terminal',
    'desktop',
    'file_transfer'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.report_format AS ENUM (
    'csv',
    'pdf',
    'excel'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.report_run_status AS ENUM (
    'pending',
    'running',
    'completed',
    'failed'
...
DO $$ BEGIN CREATE TYPE public.report_schedule AS ENUM (
    'one_time',
    'daily',
    'weekly',
    'monthly'
...
DO $$ BEGIN CREATE TYPE public.restore_type AS ENUM (
    'full',
    'selective',
    'bare_metal'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.role_scope AS ENUM (
    'system',
    'partner',
    'organization'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.script_language AS ENUM (
    'powershell',
    'bash',
    'python',
    'cmd'
...
DO $$ BEGIN CREATE TYPE public.script_run_as AS ENUM (
    'system',
    'user',
    'elevated'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.security_provider AS ENUM (
    'windows_defender',
    'bitdefender',
    'sophos',
    'sentinelone',
...
DO $$ BEGIN CREATE TYPE public.security_risk_level AS ENUM (
    'low',
    'medium',
    'high',
    'critical'
...
DO $$ BEGIN CREATE TYPE public.software_policy_mode AS ENUM (
    'allowlist',
    'blocklist',
    'audit'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.sso_provider_status AS ENUM (
    'active',
    'inactive',
    'testing'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.sso_provider_type AS ENUM (
    'oidc',
    'saml'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.threat_severity AS ENUM (
    'low',
    'medium',
    'high',
    'critical'
...
DO $$ BEGIN CREATE TYPE public.threat_status AS ENUM (
    'detected',
    'quarantined',
    'removed',
    'allowed',
...
DO $$ BEGIN CREATE TYPE public.trend_direction AS ENUM (
    'improving',
    'stable',
    'degrading'
); EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN CREATE TYPE public.trigger_type AS ENUM (
    'manual',
    'scheduled',
    'alert',
    'policy'
...
DO $$ BEGIN CREATE TYPE public.warranty_status AS ENUM (
    'active',
    'expiring',
    'expired',
    'unknown'
...
DO $$ BEGIN CREATE TYPE public.webhook_delivery_status AS ENUM (
    'pending',
    'delivered',
    'failed',
    'retrying'
...
CREATE OR REPLACE FUNCTION public.breeze_accessible_org_ids() RETURNS uuid[]
...
CREATE OR REPLACE FUNCTION public.breeze_current_scope() RETURNS text
    LANGUAGE sql STABLE
    AS $$
...
ALTER TABLE ONLY public.agent_logs FORCE ROW LEVEL SECURITY;
...
CREATE TABLE IF NOT EXISTS public.agent_versions (
    ...
    created_at timestamp without time zone DEFAULT now() NOT NULL,
    component character varying(20) DEFAULT 'agent'::character varying NOT NULL
);
...
ALTER TABLE ONLY public.ai_action_plans FORCE ROW LEVEL SECURITY;
...
CREATE TABLE IF NOT EXISTS public.ai_screenshots (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    device_id uuid NOT NULL,
    org_id uuid NOT NULL,
    session_id uuid,
...
ALTER TABLE ONLY public.ai_screenshots FORCE ROW LEVEL SECURITY;
...
CREATE TABLE IF NOT EXISTS public.automation_policy_compliance (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    policy_id uuid,
    device_id uuid NOT NULL,
...
ALTER TABLE ONLY public.backup_policies FORCE ROW LEVEL SECURITY;
...
ALTER TABLE ONLY public.backup_snapshots FORCE ROW LEVEL SECURITY;
...
CREATE TABLE IF NOT EXISTS public.brain_device_context (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
    device_id uuid NOT NULL,
...
ALTER TABLE ONLY public.brain_device_context FORCE ROW LEVEL SECURITY;
...
CREATE TABLE IF NOT EXISTS public.browser_policy_violations (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
    device_id uuid NOT NULL,
    policy_id uuid,
...
CREATE TABLE IF NOT EXISTS public.cis_baselines (
    ...
    org_id uuid NOT NULL,
    name character varying(200) NOT NULL,
    os_type public.cis_os_type NOT NULL,
    benchmark_version character varying(200) NOT NULL,
    level public.cis_baseline_level NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.cis_check_catalog (
    ...
    severity public.cis_check_severity NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.cis_remediation_actions (
    ...
    status public.cis_remediation_status DEFAULT 'pending_approval'::public.cis_remediation_status NOT NULL,
    approval_status public.cis_remediation_approval_status DEFAULT 'pending'::public.cis_remediation_approval_status NOT NULL,
    approved_by uuid,
    approved_at timestamp without time zone,
    approval_note text,
    requested_by uuid,
...
CREATE TABLE IF NOT EXISTS public.config_policy_alert_rules (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.config_policy_assignments (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.config_policy_automations (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    feature_link_id uuid NOT NULL,
    name character varying(255) NOT NULL,
    enabled boolean DEFAULT true NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.config_policy_compliance_rules (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    feature_link_id uuid NOT NULL,
    name character varying(255) NOT NULL,
    rules jsonb NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.config_policy_event_log_settings (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    feature_link_id uuid NOT NULL,
    retention_days integer DEFAULT 30 NOT NULL,
    max_events_per_cycle integer DEFAULT 100 NOT NULL,
    collect_categories text[] DEFAULT '{security,hardware,application,system}'::text[] NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.config_policy_feature_links (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    config_policy_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.config_policy_maintenance_settings (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    feature_link_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.config_policy_monitoring_settings (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    feature_link_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.config_policy_monitoring_watches (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.config_policy_patch_settings (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    feature_link_id uuid NOT NULL,
    sources text[] DEFAULT '{os}'::text[] NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.config_policy_sensitive_data_settings (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    feature_link_id uuid NOT NULL,
    detection_classes text[] DEFAULT '{credential}'::text[] NOT NULL,
    include_paths text[] DEFAULT '{}'::text[] NOT NULL,
    ...
    suppress_pattern_ids text[] DEFAULT '{}'::text[] NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.configuration_policies (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
    name character varying(255) NOT NULL,
    description text,
...
ALTER TABLE ONLY public.configuration_policies FORCE ROW LEVEL SECURITY;
...
CREATE TABLE IF NOT EXISTS public.deployment_devices (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.deployment_results (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    deployment_id uuid NOT NULL,
    device_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.device_boot_metrics (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    device_id uuid NOT NULL,
    org_id uuid NOT NULL,
    boot_timestamp timestamp without time zone NOT NULL,
    bios_seconds real,
...
ALTER TABLE ONLY public.device_boot_metrics FORCE ROW LEVEL SECURITY;
...
CREATE TABLE IF NOT EXISTS public.device_change_log (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    device_id uuid NOT NULL,
    org_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.device_disks (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    device_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.device_filesystem_cleanup_runs (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    device_id uuid NOT NULL,
    requested_by uuid,
...
CREATE TABLE IF NOT EXISTS public.device_filesystem_scan_state (
    device_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.device_filesystem_snapshots (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    device_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.device_group_memberships (
    device_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.device_hardware (
    device_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.device_ip_history (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    device_id uuid NOT NULL,
    org_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.device_network (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    device_id uuid NOT NULL,
    interface_name character varying(100) NOT NULL,
    mac_address character varying(17),
...
CREATE TABLE IF NOT EXISTS public.device_patches (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    device_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.device_registry_state (
    device_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.device_reliability (
    device_id uuid NOT NULL,
    org_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.device_reliability_history (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    device_id uuid NOT NULL,
    org_id uuid NOT NULL,
    collected_at timestamp without time zone DEFAULT now() NOT NULL,
...
--
-- Name: device_warranty; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE IF NOT EXISTS public.device_warranty (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    device_id uuid NOT NULL,
    org_id uuid NOT NULL,
    manufacturer character varying(100),
    serial_number character varying(100),
    status public.warranty_status DEFAULT 'unknown'::public.warranty_status NOT NULL,
...
ALTER TABLE ONLY public.device_warranty FORCE ROW LEVEL SECURITY;
...
CREATE TABLE IF NOT EXISTS public.dns_event_aggregations (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
    date date NOT NULL,
    integration_id uuid,
...
CREATE TABLE IF NOT EXISTS public.dns_filter_integrations (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.dns_security_events (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
    integration_id uuid NOT NULL,
    device_id uuid,
...
CREATE TABLE IF NOT EXISTS public.enrollment_keys (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
    site_id uuid,
    name character varying(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.group_membership_log (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    group_id uuid NOT NULL,
    device_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.huntress_agents (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
    integration_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.huntress_incidents (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
    integration_id uuid NOT NULL,
    device_id uuid,
...
CREATE TABLE IF NOT EXISTS public.huntress_integrations (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
    name character varying(200) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.log_correlation_rules (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
    name character varying(200) NOT NULL,
    description text,
...
CREATE TABLE IF NOT EXISTS public.log_correlations (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.log_search_queries (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
    name character varying(200) NOT NULL,
    description text,
...
CREATE TABLE IF NOT EXISTS public.network_known_guests (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.network_monitor_alert_rules (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.network_monitor_results (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    monitor_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.network_monitors (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
    asset_id uuid,
    name character varying(200) NOT NULL,
...
ALTER TABLE ONLY public.notification_routing_rules FORCE ROW LEVEL SECURITY;
...
CREATE TABLE IF NOT EXISTS public.patch_compliance_reports (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
    requested_by uuid,
...
CREATE TABLE IF NOT EXISTS public.patch_compliance_snapshots (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.patch_job_results (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    job_id uuid NOT NULL,
    device_id uuid NOT NULL,
    patch_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.patch_policies (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
    name character varying(255) NOT NULL,
    description text,
...
CREATE TABLE IF NOT EXISTS public.patch_rollbacks (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    device_id uuid NOT NULL,
    patch_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.peripheral_policies (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
    name character varying(200) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.psa_connections (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.psa_ticket_mappings (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.s1_actions (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
    device_id uuid,
    requested_by uuid,
...
CREATE TABLE IF NOT EXISTS public.s1_agents (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
    integration_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.s1_integrations (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
    name character varying(200) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.s1_site_mappings (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    integration_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.s1_threats (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
    integration_id uuid NOT NULL,
    device_id uuid,
...
CREATE TABLE IF NOT EXISTS public.script_execution_batches (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.script_to_tags (
    script_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.security_posture_org_snapshots (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
    captured_at timestamp without time zone DEFAULT now() NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.sensitive_data_findings (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
    device_id uuid NOT NULL,
    ...
    file_modified_at timestamp without time zone,
    first_seen_at timestamp without time zone DEFAULT now() NOT NULL,
...
ALTER TABLE ONLY public.sensitive_data_findings FORCE ROW LEVEL SECURITY;
...
CREATE TABLE IF NOT EXISTS public.sensitive_data_policies (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
    name character varying(200) NOT NULL,
...
ALTER TABLE ONLY public.sensitive_data_policies FORCE ROW LEVEL SECURITY;
...
CREATE TABLE IF NOT EXISTS public.sensitive_data_scans (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
    device_id uuid NOT NULL,
    policy_id uuid,
...
ALTER TABLE ONLY public.sensitive_data_scans FORCE ROW LEVEL SECURITY;
...
CREATE TABLE IF NOT EXISTS public.service_process_check_results (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
    device_id uuid NOT NULL,
    watch_type public.monitoring_watch_type NOT NULL,
...
ALTER TABLE ONLY public.service_process_check_results FORCE ROW LEVEL SECURITY;
...
CREATE TABLE IF NOT EXISTS public.snmp_alert_thresholds (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    device_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.snmp_devices (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
    asset_id uuid,
    name character varying(200) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.snmp_templates (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    name character varying(200) NOT NULL,
    description text,
...
CREATE TABLE IF NOT EXISTS public.software_compliance_status (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    device_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.software_policies (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
    name character varying(200) NOT NULL,
    description text,
...
CREATE TABLE IF NOT EXISTS public.software_policy_audit (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
    policy_id uuid,
    device_id uuid,
...
CREATE TABLE IF NOT EXISTS public.user_risk_policies (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    org_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.user_sso_identities (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    user_id uuid NOT NULL,
    provider_id uuid NOT NULL,
    external_id character varying(255) NOT NULL,
...
--
-- Name: agent_versions agent_versions_version_platform_arch_component_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.agent_versions
    ADD CONSTRAINT agent_versions_version_platform_arch_component_unique UNIQUE (version, platform, architecture, component);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: config_policy_event_log_settings config_policy_event_log_settings_feature_link_id_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.config_policy_event_log_settings
    ADD CONSTRAINT config_policy_event_log_settings_feature_link_id_unique UNIQUE (feature_link_id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: config_policy_maintenance_settings config_policy_maintenance_settings_feature_link_id_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.config_policy_maintenance_settings
    ADD CONSTRAINT config_policy_maintenance_settings_feature_link_id_unique UNIQUE (feature_link_id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: config_policy_monitoring_settings config_policy_monitoring_settings_feature_link_id_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.config_policy_monitoring_settings
    ADD CONSTRAINT config_policy_monitoring_settings_feature_link_id_unique UNIQUE (feature_link_id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: config_policy_patch_settings config_policy_patch_settings_feature_link_id_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.config_policy_patch_settings
    ADD CONSTRAINT config_policy_patch_settings_feature_link_id_unique UNIQUE (feature_link_id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: config_policy_sensitive_data_settings config_policy_sensitive_data_settings_feature_link_id_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.config_policy_sensitive_data_settings
    ADD CONSTRAINT config_policy_sensitive_data_settings_feature_link_id_unique UNIQUE (feature_link_id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: device_boot_metrics device_boot_metrics_device_boot_uniq; Type: CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.device_boot_metrics
    ADD CONSTRAINT device_boot_metrics_device_boot_uniq UNIQUE (device_id, boot_timestamp);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: device_warranty device_warranty_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.device_warranty
    ADD CONSTRAINT device_warranty_pkey PRIMARY KEY (id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
CREATE INDEX IF NOT EXISTS agent_logs_device_idx ON public.agent_logs USING btree (device_id);
...
CREATE INDEX IF NOT EXISTS agent_logs_level_component_idx ON public.agent_logs USING btree (level, component);
...
CREATE INDEX IF NOT EXISTS agent_logs_org_ts_idx ON public.agent_logs USING btree (org_id, "timestamp");
...
CREATE INDEX IF NOT EXISTS agent_logs_timestamp_idx ON public.agent_logs USING btree ("timestamp");
...
CREATE INDEX IF NOT EXISTS agent_versions_is_latest_idx ON public.agent_versions USING btree (is_latest);
...
CREATE INDEX IF NOT EXISTS ai_action_plans_session_id_idx ON public.ai_action_plans USING btree (session_id);
...
CREATE INDEX IF NOT EXISTS ai_action_plans_status_idx ON public.ai_action_plans USING btree (status);
...
CREATE UNIQUE INDEX IF NOT EXISTS ai_cost_usage_org_period_idx ON public.ai_cost_usage USING btree (org_id, period, period_key);
...
CREATE INDEX IF NOT EXISTS ai_messages_role_idx ON public.ai_messages USING btree (role);
...
CREATE INDEX IF NOT EXISTS ai_messages_session_id_idx ON public.ai_messages USING btree (session_id);
...
CREATE INDEX IF NOT EXISTS ai_screenshots_device_id_idx ON public.ai_screenshots USING btree (device_id);
...
CREATE INDEX IF NOT EXISTS ai_screenshots_expires_at_idx ON public.ai_screenshots USING btree (expires_at);
...
CREATE INDEX IF NOT EXISTS ai_screenshots_org_id_idx ON public.ai_screenshots USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS ai_sessions_flagged_at_idx ON public.ai_sessions USING btree (flagged_at) WHERE (flagged_at IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS ai_sessions_org_id_idx ON public.ai_sessions USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS ai_sessions_status_idx ON public.ai_sessions USING btree (status);
...
CREATE INDEX IF NOT EXISTS ai_sessions_user_id_idx ON public.ai_sessions USING btree (user_id);
...
CREATE INDEX IF NOT EXISTS ai_tool_executions_session_id_idx ON public.ai_tool_executions USING btree (session_id);
...
CREATE INDEX IF NOT EXISTS ai_tool_executions_status_idx ON public.ai_tool_executions USING btree (status);
...
CREATE INDEX IF NOT EXISTS alert_correlations_child_alert_id_idx ON public.alert_correlations USING btree (child_alert_id);
...
CREATE INDEX IF NOT EXISTS alert_correlations_parent_alert_id_idx ON public.alert_correlations USING btree (parent_alert_id);
...
CREATE INDEX IF NOT EXISTS alert_rules_org_id_idx ON public.alert_rules USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS alert_rules_template_id_idx ON public.alert_rules USING btree (template_id);
...
CREATE INDEX IF NOT EXISTS apc_config_policy_id_idx ON public.automation_policy_compliance USING btree (config_policy_id);


--
-- Name: apc_device_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS apc_device_id_idx ON public.automation_policy_compliance USING btree (device_id);
...
CREATE INDEX IF NOT EXISTS audit_baseline_apply_approvals_baseline_idx ON public.audit_baseline_apply_approvals USING btree (baseline_id);
...
CREATE INDEX IF NOT EXISTS audit_baseline_apply_approvals_expires_at_idx ON public.audit_baseline_apply_approvals USING btree (expires_at);
...
CREATE INDEX IF NOT EXISTS audit_baseline_apply_approvals_org_status_idx ON public.audit_baseline_apply_approvals USING btree (org_id, status);
...
CREATE INDEX IF NOT EXISTS audit_baselines_org_active_idx ON public.audit_baselines USING btree (org_id, is_active);
...
CREATE INDEX IF NOT EXISTS audit_baselines_org_os_idx ON public.audit_baselines USING btree (org_id, os_type);
...
CREATE INDEX IF NOT EXISTS audit_policy_states_device_collected_idx ON public.audit_policy_states USING btree (device_id, collected_at);
...
CREATE INDEX IF NOT EXISTS audit_policy_states_org_collected_idx ON public.audit_policy_states USING btree (org_id, collected_at);
...
CREATE INDEX IF NOT EXISTS audit_policy_states_org_device_collected_idx ON public.audit_policy_states USING btree (org_id, device_id, collected_at);
...
CREATE INDEX IF NOT EXISTS audit_results_baseline_checked_idx ON public.audit_baseline_results USING btree (baseline_id, checked_at);
...
CREATE INDEX IF NOT EXISTS audit_results_checked_at_idx ON public.audit_baseline_results USING btree (checked_at);
...
CREATE INDEX IF NOT EXISTS audit_results_org_device_idx ON public.audit_baseline_results USING btree (org_id, device_id);
...
CREATE INDEX IF NOT EXISTS backup_configs_active_idx ON public.backup_configs USING btree (is_active);
...
CREATE INDEX IF NOT EXISTS backup_configs_org_id_idx ON public.backup_configs USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS backup_configs_provider_idx ON public.backup_configs USING btree (provider);
...
CREATE INDEX IF NOT EXISTS backup_configs_type_idx ON public.backup_configs USING btree (type);
...
CREATE INDEX IF NOT EXISTS backup_jobs_config_id_idx ON public.backup_jobs USING btree (config_id);
...
CREATE INDEX IF NOT EXISTS backup_jobs_created_at_idx ON public.backup_jobs USING btree (created_at);
...
CREATE INDEX IF NOT EXISTS backup_jobs_device_id_idx ON public.backup_jobs USING btree (device_id);
...
CREATE INDEX IF NOT EXISTS backup_jobs_org_id_idx ON public.backup_jobs USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS backup_jobs_policy_id_idx ON public.backup_jobs USING btree (policy_id);
...
CREATE INDEX IF NOT EXISTS backup_jobs_started_at_idx ON public.backup_jobs USING btree (started_at);
...
CREATE INDEX IF NOT EXISTS backup_jobs_status_idx ON public.backup_jobs USING btree (status);
...
CREATE INDEX IF NOT EXISTS backup_policies_config_id_idx ON public.backup_policies USING btree (config_id);
...
CREATE INDEX IF NOT EXISTS backup_policies_enabled_idx ON public.backup_policies USING btree (enabled);
...
CREATE INDEX IF NOT EXISTS backup_policies_org_id_idx ON public.backup_policies USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS backup_snapshots_device_id_idx ON public.backup_snapshots USING btree (device_id);
...
CREATE INDEX IF NOT EXISTS backup_snapshots_job_id_idx ON public.backup_snapshots USING btree (job_id);
...
CREATE INDEX IF NOT EXISTS backup_snapshots_org_id_idx ON public.backup_snapshots USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS backup_snapshots_parent_snapshot_id_idx ON public.backup_snapshots USING btree (parent_snapshot_id);
...
CREATE INDEX IF NOT EXISTS backup_snapshots_snapshot_id_idx ON public.backup_snapshots USING btree (snapshot_id);
...
CREATE INDEX IF NOT EXISTS brain_device_context_device_active_idx ON public.brain_device_context USING btree (device_id, resolved_at);
...
CREATE INDEX IF NOT EXISTS brain_device_context_device_id_idx ON public.brain_device_context USING btree (device_id);
...
CREATE INDEX IF NOT EXISTS brain_device_context_device_type_idx ON public.brain_device_context USING btree (device_id, context_type);
...
CREATE INDEX IF NOT EXISTS brain_device_context_org_id_idx ON public.brain_device_context USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS browser_ext_extension_id_idx ON public.browser_extensions USING btree (extension_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS browser_ext_org_device_browser_ext_uniq ON public.browser_extensions USING btree (org_id, device_id, browser, extension_id);
...
CREATE INDEX IF NOT EXISTS browser_ext_org_device_idx ON public.browser_extensions USING btree (org_id, device_id);
...
CREATE INDEX IF NOT EXISTS browser_ext_risk_level_idx ON public.browser_extensions USING btree (org_id, risk_level);
...
CREATE INDEX IF NOT EXISTS browser_policy_org_idx ON public.browser_policies USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS browser_policy_violations_org_device_idx ON public.browser_policy_violations USING btree (org_id, device_id);
...
CREATE INDEX IF NOT EXISTS browser_policy_violations_policy_idx ON public.browser_policy_violations USING btree (policy_id);
...
CREATE INDEX IF NOT EXISTS browser_policy_violations_unresolved_idx ON public.browser_policy_violations USING btree (org_id, resolved_at);
...
CREATE INDEX IF NOT EXISTS cis_baselines_org_active_idx ON public.cis_baselines USING btree (org_id, is_active);
...
CREATE INDEX IF NOT EXISTS cis_baselines_org_os_idx ON public.cis_baselines USING btree (org_id, os_type);
...
CREATE INDEX IF NOT EXISTS cis_check_catalog_os_benchmark_idx ON public.cis_check_catalog USING btree (os_type, benchmark_version);


--
-- Name: cis_check_catalog_unique_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX IF NOT EXISTS cis_check_catalog_unique_idx ON public.cis_check_catalog USING btree (os_type, benchmark_version, level, check_id);
...
CREATE INDEX IF NOT EXISTS cis_remediation_check_idx ON public.cis_remediation_actions USING btree (check_id);
...
CREATE INDEX IF NOT EXISTS cis_remediation_org_approval_status_idx ON public.cis_remediation_actions USING btree (org_id, approval_status, status);
...
CREATE INDEX IF NOT EXISTS cis_remediation_org_device_status_idx ON public.cis_remediation_actions USING btree (org_id, device_id, status);
...
CREATE INDEX IF NOT EXISTS cis_remediation_result_idx ON public.cis_remediation_actions USING btree (baseline_result_id);
...
CREATE INDEX IF NOT EXISTS cis_results_baseline_checked_idx ON public.cis_baseline_results USING btree (baseline_id, checked_at);
...
CREATE INDEX IF NOT EXISTS cis_results_org_device_checked_idx ON public.cis_baseline_results USING btree (org_id, device_id, checked_at);
...
CREATE INDEX IF NOT EXISTS cis_results_score_idx ON public.cis_baseline_results USING btree (score);
...
CREATE INDEX IF NOT EXISTS config_assignments_level_target_idx ON public.config_policy_assignments USING btree (level, target_id);
...
CREATE INDEX IF NOT EXISTS config_assignments_policy_id_idx ON public.config_policy_assignments USING btree (config_policy_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS config_assignments_unique ON public.config_policy_assignments USING btree (config_policy_id, level, target_id);
...
CREATE INDEX IF NOT EXISTS config_feature_links_feature_type_idx ON public.config_policy_feature_links USING btree (feature_type);
...
CREATE INDEX IF NOT EXISTS config_feature_links_policy_id_idx ON public.config_policy_feature_links USING btree (config_policy_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS config_feature_links_unique ON public.config_policy_feature_links USING btree (config_policy_id, feature_type);
...
CREATE INDEX IF NOT EXISTS config_policies_org_id_idx ON public.configuration_policies USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS config_policies_status_idx ON public.configuration_policies USING btree (status);
...
CREATE INDEX IF NOT EXISTS cpar_feature_link_id_idx ON public.config_policy_alert_rules USING btree (feature_link_id);
...
CREATE INDEX IF NOT EXISTS cpaut_feature_link_id_idx ON public.config_policy_automations USING btree (feature_link_id);
...
CREATE INDEX IF NOT EXISTS cpaut_trigger_type_enabled_idx ON public.config_policy_automations USING btree (trigger_type);
...
CREATE INDEX IF NOT EXISTS cpcr_feature_link_id_idx ON public.config_policy_compliance_rules USING btree (feature_link_id);
...
CREATE INDEX IF NOT EXISTS cpmon_watches_settings_id_idx ON public.config_policy_monitoring_watches USING btree (settings_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS deployment_devices_deployment_device_unique ON public.deployment_devices USING btree (deployment_id, device_id);
...
CREATE INDEX IF NOT EXISTS deployment_results_deployment_id_idx ON public.deployment_results USING btree (deployment_id);
...
CREATE INDEX IF NOT EXISTS deployment_results_device_id_idx ON public.deployment_results USING btree (device_id);
...
CREATE INDEX IF NOT EXISTS deployment_results_status_idx ON public.deployment_results USING btree (status);
...
CREATE INDEX IF NOT EXISTS device_boot_metrics_device_boot_idx ON public.device_boot_metrics USING btree (device_id, boot_timestamp);
...
CREATE INDEX IF NOT EXISTS device_boot_metrics_device_created_idx ON public.device_boot_metrics USING btree (device_id, created_at);
...
CREATE INDEX IF NOT EXISTS device_boot_metrics_org_device_idx ON public.device_boot_metrics USING btree (org_id, device_id);
...
CREATE INDEX IF NOT EXISTS device_change_log_action_idx ON public.device_change_log USING btree (change_action);
...
CREATE INDEX IF NOT EXISTS device_change_log_created_at_idx ON public.device_change_log USING btree (created_at);
...
CREATE UNIQUE INDEX IF NOT EXISTS device_change_log_device_fingerprint_uniq ON public.device_change_log USING btree (device_id, fingerprint);
...
CREATE INDEX IF NOT EXISTS device_change_log_device_id_idx ON public.device_change_log USING btree (device_id);
...
CREATE INDEX IF NOT EXISTS device_change_log_device_time_idx ON public.device_change_log USING btree (device_id, "timestamp");
...
CREATE INDEX IF NOT EXISTS device_change_log_org_id_idx ON public.device_change_log USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS device_change_log_org_time_idx ON public.device_change_log USING btree (org_id, "timestamp");
...
CREATE INDEX IF NOT EXISTS device_change_log_timestamp_idx ON public.device_change_log USING btree ("timestamp");
...
CREATE INDEX IF NOT EXISTS device_change_log_type_idx ON public.device_change_log USING btree (change_type);
...
CREATE INDEX IF NOT EXISTS device_connections_device_port_state_idx ON public.device_connections USING btree (device_id, local_port, state);
...
CREATE INDEX IF NOT EXISTS device_connections_device_updated_idx ON public.device_connections USING btree (device_id, updated_at);
...
CREATE INDEX IF NOT EXISTS device_event_logs_cat_level_idx ON public.device_event_logs USING btree (category, level);
...
CREATE UNIQUE INDEX IF NOT EXISTS device_event_logs_dedup_idx ON public.device_event_logs USING btree (device_id, source, event_id);
...
CREATE INDEX IF NOT EXISTS device_event_logs_device_idx ON public.device_event_logs USING btree (device_id);
...
CREATE INDEX IF NOT EXISTS device_event_logs_message_trgm_idx ON public.device_event_logs USING gin (message public.gin_trgm_ops);
...
CREATE INDEX IF NOT EXISTS device_event_logs_org_ts_idx ON public.device_event_logs USING btree (org_id, "timestamp");
...
CREATE INDEX IF NOT EXISTS device_event_logs_search_vector_idx ON public.device_event_logs USING gin (search_vector);
...
CREATE INDEX IF NOT EXISTS device_event_logs_source_trgm_idx ON public.device_event_logs USING gin (source public.gin_trgm_ops);
...
CREATE UNIQUE INDEX IF NOT EXISTS device_ip_history_active_assignment_uniq ON public.device_ip_history USING btree (device_id, interface_name, ip_address, ip_type) WHERE (is_active = true);
...
CREATE INDEX IF NOT EXISTS device_ip_history_device_id_idx ON public.device_ip_history USING btree (device_id);
...
CREATE INDEX IF NOT EXISTS device_ip_history_first_seen_idx ON public.device_ip_history USING btree (first_seen);
...
CREATE INDEX IF NOT EXISTS device_ip_history_ip_address_idx ON public.device_ip_history USING btree (ip_address);
...
CREATE INDEX IF NOT EXISTS device_ip_history_ip_time_idx ON public.device_ip_history USING btree (ip_address, first_seen, last_seen);
...
CREATE INDEX IF NOT EXISTS device_ip_history_is_active_idx ON public.device_ip_history USING btree (is_active);
...
CREATE INDEX IF NOT EXISTS device_ip_history_last_seen_idx ON public.device_ip_history USING btree (last_seen);
...
CREATE INDEX IF NOT EXISTS device_ip_history_org_id_idx ON public.device_ip_history USING btree (org_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS device_patches_device_patch_unique ON public.device_patches USING btree (device_id, patch_id);
...
CREATE INDEX IF NOT EXISTS device_sessions_device_active_idx ON public.device_sessions USING btree (device_id, is_active);
...
CREATE INDEX IF NOT EXISTS device_sessions_device_login_idx ON public.device_sessions USING btree (device_id, login_at);
...
CREATE INDEX IF NOT EXISTS device_sessions_device_user_idx ON public.device_sessions USING btree (device_id, username);
...
CREATE INDEX IF NOT EXISTS device_sessions_org_active_idx ON public.device_sessions USING btree (org_id, is_active);


--
-- Name: device_warranty_device_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX IF NOT EXISTS device_warranty_device_id_idx ON public.device_warranty USING btree (device_id);


--
-- Name: device_warranty_end_date_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS device_warranty_end_date_idx ON public.device_warranty USING btree (warranty_end_date);


--
-- Name: device_warranty_next_sync_at_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS device_warranty_next_sync_at_idx ON public.device_warranty USING btree (next_sync_at);


--
-- Name: device_warranty_org_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS device_warranty_org_id_idx ON public.device_warranty USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS devices_management_posture_categories_idx ON public.devices USING gin (((management_posture -> 'categories'::text)));
...
CREATE INDEX IF NOT EXISTS devices_management_posture_collected_idx ON public.devices USING btree (((management_posture ->> 'collectedAt'::text)));
...
CREATE INDEX IF NOT EXISTS devices_management_posture_join_type_idx ON public.devices USING btree ((((management_posture -> 'identity'::text) ->> 'joinType'::text)));
...
CREATE INDEX IF NOT EXISTS devices_mtls_cert_expires_idx ON public.devices USING btree (mtls_cert_expires_at) WHERE ((mtls_cert_expires_at IS NOT NULL) AND (status <> 'decommissioned'::public.device_status));
...
CREATE INDEX IF NOT EXISTS devices_quarantined_idx ON public.devices USING btree (org_id, status) WHERE (status = 'quarantined'::public.device_status);
...
CREATE UNIQUE INDEX IF NOT EXISTS discovered_assets_org_ip_unique ON public.discovered_assets USING btree (org_id, ip_address);
...
CREATE INDEX IF NOT EXISTS dns_event_agg_device_id_idx ON public.dns_event_aggregations USING btree (device_id);
...
CREATE INDEX IF NOT EXISTS dns_event_agg_integration_id_idx ON public.dns_event_aggregations USING btree (integration_id);
...
CREATE INDEX IF NOT EXISTS dns_event_agg_org_date_idx ON public.dns_event_aggregations USING btree (org_id, date);
...
CREATE INDEX IF NOT EXISTS dns_event_agg_org_date_integration_idx ON public.dns_event_aggregations USING btree (org_id, date, integration_id);
...
CREATE INDEX IF NOT EXISTS dns_filter_integrations_org_id_idx ON public.dns_filter_integrations USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS dns_filter_integrations_provider_idx ON public.dns_filter_integrations USING btree (provider);
...
CREATE INDEX IF NOT EXISTS dns_policies_integration_id_idx ON public.dns_policies USING btree (integration_id);
...
CREATE INDEX IF NOT EXISTS dns_policies_org_id_idx ON public.dns_policies USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS dns_security_events_action_cat_idx ON public.dns_security_events USING btree (action, category);
...
CREATE INDEX IF NOT EXISTS dns_security_events_device_id_idx ON public.dns_security_events USING btree (device_id);
...
CREATE INDEX IF NOT EXISTS dns_security_events_domain_idx ON public.dns_security_events USING btree (domain);
...
CREATE INDEX IF NOT EXISTS dns_security_events_integration_id_idx ON public.dns_security_events USING btree (integration_id);
...
CREATE INDEX IF NOT EXISTS dns_security_events_org_ts_idx ON public.dns_security_events USING btree (org_id, "timestamp");
...
CREATE UNIQUE INDEX IF NOT EXISTS dns_security_events_provider_evt_uniq ON public.dns_security_events USING btree (integration_id, provider_event_id);
...
CREATE INDEX IF NOT EXISTS dns_security_events_provider_id_idx ON public.dns_security_events USING btree (integration_id, provider_event_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS huntress_agents_agent_id_idx ON public.huntress_agents USING btree (integration_id, huntress_agent_id);
...
CREATE INDEX IF NOT EXISTS huntress_agents_org_device_idx ON public.huntress_agents USING btree (org_id, device_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS huntress_incidents_external_idx ON public.huntress_incidents USING btree (integration_id, huntress_incident_id);
...
CREATE INDEX IF NOT EXISTS huntress_incidents_org_status_idx ON public.huntress_incidents USING btree (org_id, status);
...
CREATE UNIQUE INDEX IF NOT EXISTS huntress_integrations_org_idx ON public.huntress_integrations USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS idx_audit_logs_initiated_by ON public.audit_logs USING btree (initiated_by);
...
CREATE INDEX IF NOT EXISTS idx_device_filesystem_cleanup_runs_device_requested ON public.device_filesystem_cleanup_runs USING btree (device_id, requested_at);
...
CREATE INDEX IF NOT EXISTS idx_device_filesystem_snapshots_device_captured ON public.device_filesystem_snapshots USING btree (device_id, captured_at);
...
CREATE INDEX IF NOT EXISTS log_correlation_rules_active_idx ON public.log_correlation_rules USING btree (is_active);
...
CREATE INDEX IF NOT EXISTS log_correlation_rules_org_id_idx ON public.log_correlation_rules USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS log_correlations_org_id_idx ON public.log_correlations USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS log_correlations_rule_id_idx ON public.log_correlations USING btree (rule_id);
...
CREATE INDEX IF NOT EXISTS log_correlations_status_idx ON public.log_correlations USING btree (status);
...
CREATE INDEX IF NOT EXISTS log_search_queries_created_by_idx ON public.log_search_queries USING btree (created_by);
...
CREATE INDEX IF NOT EXISTS log_search_queries_org_id_idx ON public.log_search_queries USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS network_baselines_org_id_idx ON public.network_baselines USING btree (org_id);


--
-- Name: network_baselines_org_site_subnet_unique; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX IF NOT EXISTS network_baselines_org_site_subnet_unique ON public.network_baselines USING btree (org_id, site_id, subnet);
...
CREATE INDEX IF NOT EXISTS network_baselines_site_id_idx ON public.network_baselines USING btree (site_id);
...
CREATE INDEX IF NOT EXISTS network_change_events_acknowledged_idx ON public.network_change_events USING btree (acknowledged);
...
CREATE INDEX IF NOT EXISTS network_change_events_baseline_id_idx ON public.network_change_events USING btree (baseline_id);
...
CREATE INDEX IF NOT EXISTS network_change_events_detected_at_idx ON public.network_change_events USING btree (detected_at);
...
CREATE INDEX IF NOT EXISTS network_change_events_org_id_idx ON public.network_change_events USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS network_change_events_profile_id_idx ON public.network_change_events USING btree (profile_id);
...
CREATE INDEX IF NOT EXISTS network_change_events_site_id_idx ON public.network_change_events USING btree (site_id);
...
CREATE INDEX IF NOT EXISTS network_known_guests_partner_id_idx ON public.network_known_guests USING btree (partner_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS network_known_guests_partner_mac_unique ON public.network_known_guests USING btree (partner_id, mac_address);
...
CREATE INDEX IF NOT EXISTS network_monitor_results_monitor_id_idx ON public.network_monitor_results USING btree (monitor_id);
...
CREATE INDEX IF NOT EXISTS network_monitor_results_timestamp_idx ON public.network_monitor_results USING btree ("timestamp");
...
CREATE INDEX IF NOT EXISTS network_monitors_is_active_idx ON public.network_monitors USING btree (is_active);
...
CREATE INDEX IF NOT EXISTS network_monitors_monitor_type_idx ON public.network_monitors USING btree (monitor_type);
...
CREATE INDEX IF NOT EXISTS network_monitors_org_id_idx ON public.network_monitors USING btree (org_id);


--
-- Name: notification_routing_rules_org_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS notification_routing_rules_org_id_idx ON public.notification_routing_rules USING btree (org_id);


--
-- Name: notification_routing_rules_priority_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS notification_routing_rules_priority_idx ON public.notification_routing_rules USING btree (org_id, priority);
...
CREATE UNIQUE INDEX IF NOT EXISTS patch_approvals_org_patch_ring_unique ON public.patch_approvals USING btree (org_id, patch_id, COALESCE(ring_id, '00000000-0000-0000-0000-000000000000'::uuid));
...
CREATE INDEX IF NOT EXISTS patch_compliance_reports_org_created_idx ON public.patch_compliance_reports USING btree (org_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS patch_compliance_reports_status_created_idx ON public.patch_compliance_reports USING btree (status, created_at DESC);
...
CREATE UNIQUE INDEX IF NOT EXISTS patches_source_external_id_unique ON public.patches USING btree (source, external_id);
...
CREATE INDEX IF NOT EXISTS peripheral_events_org_device_time_idx ON public.peripheral_events USING btree (org_id, device_id, occurred_at);
...
CREATE INDEX IF NOT EXISTS peripheral_events_org_policy_time_idx ON public.peripheral_events USING btree (org_id, policy_id, occurred_at);
...
CREATE UNIQUE INDEX IF NOT EXISTS peripheral_events_source_event_idx ON public.peripheral_events USING btree (org_id, device_id, source_event_id) WHERE (source_event_id IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS peripheral_events_type_idx ON public.peripheral_events USING btree (event_type);


--
-- Name: peripheral_events_type_time_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS peripheral_events_type_time_idx ON public.peripheral_events USING btree (event_type, occurred_at);
...
CREATE INDEX IF NOT EXISTS peripheral_policy_org_active_idx ON public.peripheral_policies USING btree (org_id, is_active);
...
CREATE INDEX IF NOT EXISTS peripheral_policy_org_class_idx ON public.peripheral_policies USING btree (org_id, device_class);
...
CREATE INDEX IF NOT EXISTS playbook_definitions_active_idx ON public.playbook_definitions USING btree (is_active);
...
CREATE INDEX IF NOT EXISTS playbook_definitions_category_idx ON public.playbook_definitions USING btree (category);
...
CREATE INDEX IF NOT EXISTS playbook_definitions_org_id_idx ON public.playbook_definitions USING btree (org_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS playbook_definitions_scope_name_uniq ON public.playbook_definitions USING btree (COALESCE(org_id, '00000000-0000-0000-0000-000000000000'::uuid), lower((name)::text));
...
CREATE INDEX IF NOT EXISTS playbook_executions_created_at_idx ON public.playbook_executions USING btree (created_at);
...
CREATE INDEX IF NOT EXISTS playbook_executions_device_id_idx ON public.playbook_executions USING btree (device_id);
...
CREATE INDEX IF NOT EXISTS playbook_executions_org_id_idx ON public.playbook_executions USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS playbook_executions_playbook_id_idx ON public.playbook_executions USING btree (playbook_id);
...
CREATE INDEX IF NOT EXISTS playbook_executions_status_idx ON public.playbook_executions USING btree (status);
...
CREATE UNIQUE INDEX IF NOT EXISTS plugin_installations_org_catalog_unique ON public.plugin_installations USING btree (org_id, catalog_id);
...
CREATE INDEX IF NOT EXISTS reliability_history_device_collected_idx ON public.device_reliability_history USING btree (device_id, collected_at);
...
CREATE INDEX IF NOT EXISTS reliability_history_org_collected_idx ON public.device_reliability_history USING btree (org_id, collected_at);
...
CREATE INDEX IF NOT EXISTS reliability_org_score_idx ON public.device_reliability USING btree (org_id, reliability_score);
...
CREATE INDEX IF NOT EXISTS reliability_score_idx ON public.device_reliability USING btree (reliability_score);
...
CREATE INDEX IF NOT EXISTS reliability_trend_idx ON public.device_reliability USING btree (trend_direction);
...
CREATE INDEX IF NOT EXISTS restore_jobs_device_id_idx ON public.restore_jobs USING btree (device_id);
...
CREATE INDEX IF NOT EXISTS restore_jobs_org_id_idx ON public.restore_jobs USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS restore_jobs_snapshot_id_idx ON public.restore_jobs USING btree (snapshot_id);
...
CREATE INDEX IF NOT EXISTS restore_jobs_status_idx ON public.restore_jobs USING btree (status);
...
CREATE INDEX IF NOT EXISTS s1_actions_org_status_idx ON public.s1_actions USING btree (org_id, status);
...
CREATE INDEX IF NOT EXISTS s1_actions_provider_action_idx ON public.s1_actions USING btree (provider_action_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS s1_agents_external_idx ON public.s1_agents USING btree (integration_id, s1_agent_id);
...
CREATE INDEX IF NOT EXISTS s1_agents_integration_idx ON public.s1_agents USING btree (integration_id);
...
CREATE INDEX IF NOT EXISTS s1_agents_org_device_idx ON public.s1_agents USING btree (org_id, device_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS s1_integrations_org_idx ON public.s1_integrations USING btree (org_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS s1_site_mappings_integration_site_idx ON public.s1_site_mappings USING btree (integration_id, site_name);
...
CREATE INDEX IF NOT EXISTS s1_site_mappings_org_idx ON public.s1_site_mappings USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS s1_threats_device_idx ON public.s1_threats USING btree (device_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS s1_threats_external_idx ON public.s1_threats USING btree (integration_id, s1_threat_id);
...
CREATE INDEX IF NOT EXISTS s1_threats_integration_detected_idx ON public.s1_threats USING btree (integration_id, detected_at);
...
CREATE INDEX IF NOT EXISTS s1_threats_integration_idx ON public.s1_threats USING btree (integration_id);
...
CREATE INDEX IF NOT EXISTS s1_threats_org_severity_status_idx ON public.s1_threats USING btree (org_id, severity, status);
...
CREATE INDEX IF NOT EXISTS s1_threats_org_status_idx ON public.s1_threats USING btree (org_id, status);
...
CREATE INDEX IF NOT EXISTS script_categories_org_id_idx ON public.script_categories USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS script_categories_org_name_idx ON public.script_categories USING btree (org_id, name);
...
CREATE INDEX IF NOT EXISTS script_categories_parent_id_idx ON public.script_categories USING btree (parent_id);
...
CREATE INDEX IF NOT EXISTS script_tags_org_id_idx ON public.script_tags USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS script_tags_org_name_idx ON public.script_tags USING btree (org_id, name);
...
CREATE INDEX IF NOT EXISTS script_templates_category_idx ON public.script_templates USING btree (category);
...
CREATE INDEX IF NOT EXISTS script_templates_language_idx ON public.script_templates USING btree (language);
...
CREATE INDEX IF NOT EXISTS script_templates_name_idx ON public.script_templates USING btree (name);
...
CREATE INDEX IF NOT EXISTS script_to_tags_tag_id_idx ON public.script_to_tags USING btree (tag_id);
...
CREATE INDEX IF NOT EXISTS script_versions_script_id_idx ON public.script_versions USING btree (script_id);
...
CREATE INDEX IF NOT EXISTS script_versions_script_id_version_idx ON public.script_versions USING btree (script_id, version);
...
CREATE INDEX IF NOT EXISTS security_policies_org_id_idx ON public.security_policies USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS security_posture_org_snapshots_org_captured_idx ON public.security_posture_org_snapshots USING btree (org_id, captured_at);
...
CREATE INDEX IF NOT EXISTS security_posture_org_snapshots_org_score_idx ON public.security_posture_org_snapshots USING btree (org_id, overall_score);
...
CREATE INDEX IF NOT EXISTS security_posture_snapshots_device_captured_idx ON public.security_posture_snapshots USING btree (device_id, captured_at);
...
CREATE INDEX IF NOT EXISTS security_posture_snapshots_org_captured_idx ON public.security_posture_snapshots USING btree (org_id, captured_at);
...
CREATE INDEX IF NOT EXISTS security_posture_snapshots_org_device_captured_idx ON public.security_posture_snapshots USING btree (org_id, device_id, captured_at);
...
CREATE INDEX IF NOT EXISTS security_posture_snapshots_org_score_idx ON public.security_posture_snapshots USING btree (org_id, overall_score);
...
CREATE INDEX IF NOT EXISTS security_scans_device_started_idx ON public.security_scans USING btree (device_id, started_at);
...
CREATE INDEX IF NOT EXISTS security_scans_status_idx ON public.security_scans USING btree (status);
...
CREATE UNIQUE INDEX IF NOT EXISTS security_status_device_id_unique ON public.security_status USING btree (device_id);
...
CREATE INDEX IF NOT EXISTS security_status_provider_idx ON public.security_status USING btree (provider);
...
CREATE INDEX IF NOT EXISTS security_threats_device_detected_idx ON public.security_threats USING btree (device_id, detected_at);
...
CREATE INDEX IF NOT EXISTS security_threats_device_status_detected_idx ON public.security_threats USING btree (device_id, status, detected_at);
...
CREATE INDEX IF NOT EXISTS security_threats_status_idx ON public.security_threats USING btree (status);
...
CREATE INDEX IF NOT EXISTS sensitive_findings_org_last_seen_idx ON public.sensitive_data_findings USING btree (org_id, last_seen_at);
...
CREATE INDEX IF NOT EXISTS sensitive_findings_org_risk_idx ON public.sensitive_data_findings USING btree (org_id, risk);
...
CREATE INDEX IF NOT EXISTS sensitive_findings_scan_idx ON public.sensitive_data_findings USING btree (scan_id);
...
CREATE INDEX IF NOT EXISTS sensitive_policy_org_idx ON public.sensitive_data_policies USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS sensitive_scan_org_device_idx ON public.sensitive_data_scans USING btree (org_id, device_id);
...
CREATE INDEX IF NOT EXISTS sensitive_scan_org_idempotency_idx ON public.sensitive_data_scans USING btree (org_id, idempotency_key);
...
CREATE INDEX IF NOT EXISTS sensitive_scan_status_idx ON public.sensitive_data_scans USING btree (status);
...
CREATE INDEX IF NOT EXISTS snmp_devices_asset_id_idx ON public.snmp_devices USING btree (asset_id);
...
CREATE INDEX IF NOT EXISTS snmp_metrics_device_id_idx ON public.snmp_metrics USING btree (device_id);
...
CREATE INDEX IF NOT EXISTS snmp_metrics_oid_idx ON public.snmp_metrics USING btree (oid);
...
CREATE INDEX IF NOT EXISTS snmp_metrics_timestamp_idx ON public.snmp_metrics USING btree ("timestamp");
...
CREATE INDEX IF NOT EXISTS software_catalog_category_idx ON public.software_catalog USING btree (category);
...
CREATE INDEX IF NOT EXISTS software_catalog_name_idx ON public.software_catalog USING btree (name);
...
CREATE INDEX IF NOT EXISTS software_catalog_org_id_idx ON public.software_catalog USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS software_catalog_vendor_idx ON public.software_catalog USING btree (vendor);
...
CREATE INDEX IF NOT EXISTS software_compliance_device_id_idx ON public.software_compliance_status USING btree (device_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS software_compliance_device_policy_unique ON public.software_compliance_status USING btree (device_id, policy_id);
...
CREATE INDEX IF NOT EXISTS software_compliance_policy_id_idx ON public.software_compliance_status USING btree (policy_id);
...
CREATE INDEX IF NOT EXISTS software_compliance_status_idx ON public.software_compliance_status USING btree (status);
...
CREATE INDEX IF NOT EXISTS software_deployments_org_id_idx ON public.software_deployments USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS software_deployments_schedule_idx ON public.software_deployments USING btree (schedule_type, scheduled_at);
...
CREATE INDEX IF NOT EXISTS software_deployments_version_id_idx ON public.software_deployments USING btree (software_version_id);
...
CREATE INDEX IF NOT EXISTS software_inventory_catalog_id_idx ON public.software_inventory USING btree (catalog_id);
...
CREATE INDEX IF NOT EXISTS software_inventory_device_id_idx ON public.software_inventory USING btree (device_id);
...
CREATE INDEX IF NOT EXISTS software_inventory_name_idx ON public.software_inventory USING btree (name);
...
CREATE INDEX IF NOT EXISTS software_inventory_name_vendor_idx ON public.software_inventory USING btree (name, vendor);
...
CREATE INDEX IF NOT EXISTS software_policies_active_priority_idx ON public.software_policies USING btree (is_active, priority);
...
CREATE INDEX IF NOT EXISTS software_policies_org_id_idx ON public.software_policies USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS software_policies_target_type_idx ON public.software_policies USING btree (target_type);
...
CREATE INDEX IF NOT EXISTS software_policy_audit_device_id_idx ON public.software_policy_audit USING btree (device_id);
...
CREATE INDEX IF NOT EXISTS software_policy_audit_org_id_idx ON public.software_policy_audit USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS software_policy_audit_policy_id_idx ON public.software_policy_audit USING btree (policy_id);
...
CREATE INDEX IF NOT EXISTS software_policy_audit_timestamp_idx ON public.software_policy_audit USING btree ("timestamp");
...
CREATE INDEX IF NOT EXISTS software_versions_catalog_id_idx ON public.software_versions USING btree (catalog_id);
...
CREATE INDEX IF NOT EXISTS software_versions_catalog_version_idx ON public.software_versions USING btree (catalog_id, version);
...
CREATE INDEX IF NOT EXISTS software_versions_latest_idx ON public.software_versions USING btree (catalog_id, is_latest);
...
CREATE INDEX IF NOT EXISTS spc_results_device_id_idx ON public.service_process_check_results USING btree (device_id);
...
CREATE INDEX IF NOT EXISTS spc_results_device_name_ts_idx ON public.service_process_check_results USING btree (device_id, name, "timestamp");
...
CREATE INDEX IF NOT EXISTS spc_results_org_id_idx ON public.service_process_check_results USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS time_series_metrics_device_timestamp_idx ON public.time_series_metrics USING btree ("timestamp", device_id);
...
CREATE INDEX IF NOT EXISTS time_series_metrics_org_timestamp_idx ON public.time_series_metrics USING btree (org_id, "timestamp");
...
CREATE INDEX IF NOT EXISTS user_notifications_created_at_idx ON public.user_notifications USING btree (created_at);
...
CREATE INDEX IF NOT EXISTS user_notifications_user_read_idx ON public.user_notifications USING btree (user_id, read);
...
CREATE INDEX IF NOT EXISTS user_risk_events_org_event_type_time_idx ON public.user_risk_events USING btree (org_id, event_type, occurred_at);
...
CREATE INDEX IF NOT EXISTS user_risk_events_org_user_time_idx ON public.user_risk_events USING btree (org_id, user_id, occurred_at);
...
CREATE INDEX IF NOT EXISTS user_risk_org_score_idx ON public.user_risk_scores USING btree (org_id, score);
...
CREATE UNIQUE INDEX IF NOT EXISTS user_risk_org_user_calc_idx ON public.user_risk_scores USING btree (org_id, user_id, calculated_at);
...
CREATE INDEX IF NOT EXISTS user_risk_org_user_idx ON public.user_risk_scores USING btree (org_id, user_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS user_risk_policy_org_idx ON public.user_risk_policies USING btree (org_id);
...
CREATE INDEX IF NOT EXISTS user_risk_score_idx ON public.user_risk_scores USING btree (score);
...
--
-- Name: agent_logs agent_logs_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.agent_logs
    ADD CONSTRAINT agent_logs_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: agent_logs agent_logs_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.agent_logs
    ADD CONSTRAINT agent_logs_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: ai_action_plans ai_action_plans_approved_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.ai_action_plans
    ADD CONSTRAINT ai_action_plans_approved_by_users_id_fk FOREIGN KEY (approved_by) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: ai_action_plans ai_action_plans_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.ai_action_plans
    ADD CONSTRAINT ai_action_plans_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: ai_action_plans ai_action_plans_session_id_ai_sessions_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.ai_action_plans
    ADD CONSTRAINT ai_action_plans_session_id_ai_sessions_id_fk FOREIGN KEY (session_id) REFERENCES public.ai_sessions(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: ai_screenshots ai_screenshots_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.ai_screenshots
    ADD CONSTRAINT ai_screenshots_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: ai_screenshots ai_screenshots_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.ai_screenshots
    ADD CONSTRAINT ai_screenshots_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: ai_screenshots ai_screenshots_session_id_ai_sessions_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.ai_screenshots
    ADD CONSTRAINT ai_screenshots_session_id_ai_sessions_id_fk FOREIGN KEY (session_id) REFERENCES public.ai_sessions(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: ai_sessions ai_sessions_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.ai_sessions
    ADD CONSTRAINT ai_sessions_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: ai_sessions ai_sessions_flagged_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.ai_sessions
    ADD CONSTRAINT ai_sessions_flagged_by_users_id_fk FOREIGN KEY (flagged_by) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: audit_baseline_apply_approvals audit_baseline_apply_approvals_approved_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.audit_baseline_apply_approvals
    ADD CONSTRAINT audit_baseline_apply_approvals_approved_by_users_id_fk FOREIGN KEY (approved_by) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: audit_baseline_apply_approvals audit_baseline_apply_approvals_baseline_id_audit_baselines_id_f; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.audit_baseline_apply_approvals
    ADD CONSTRAINT audit_baseline_apply_approvals_baseline_id_audit_baselines_id_f FOREIGN KEY (baseline_id) REFERENCES public.audit_baselines(id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: audit_baseline_apply_approvals audit_baseline_apply_approvals_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.audit_baseline_apply_approvals
    ADD CONSTRAINT audit_baseline_apply_approvals_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: audit_baseline_apply_approvals audit_baseline_apply_approvals_requested_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.audit_baseline_apply_approvals
    ADD CONSTRAINT audit_baseline_apply_approvals_requested_by_users_id_fk FOREIGN KEY (requested_by) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: audit_baseline_results audit_baseline_results_baseline_id_audit_baselines_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.audit_baseline_results
    ADD CONSTRAINT audit_baseline_results_baseline_id_audit_baselines_id_fk FOREIGN KEY (baseline_id) REFERENCES public.audit_baselines(id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: audit_baseline_results audit_baseline_results_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.audit_baseline_results
    ADD CONSTRAINT audit_baseline_results_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: audit_baseline_results audit_baseline_results_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.audit_baseline_results
    ADD CONSTRAINT audit_baseline_results_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: audit_baselines audit_baselines_created_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.audit_baselines
    ADD CONSTRAINT audit_baselines_created_by_users_id_fk FOREIGN KEY (created_by) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: audit_baselines audit_baselines_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.audit_baselines
    ADD CONSTRAINT audit_baselines_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: audit_policy_states audit_policy_states_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.audit_policy_states
    ADD CONSTRAINT audit_policy_states_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: audit_policy_states audit_policy_states_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.audit_policy_states
    ADD CONSTRAINT audit_policy_states_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: backup_jobs backup_jobs_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.backup_jobs
    ADD CONSTRAINT backup_jobs_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: backup_jobs backup_jobs_policy_id_backup_policies_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.backup_jobs
    ADD CONSTRAINT backup_jobs_policy_id_backup_policies_id_fk FOREIGN KEY (policy_id) REFERENCES public.backup_policies(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: backup_policies backup_policies_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.backup_policies
    ADD CONSTRAINT backup_policies_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: backup_snapshots backup_snapshots_config_id_backup_configs_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.backup_snapshots
    ADD CONSTRAINT backup_snapshots_config_id_backup_configs_id_fk FOREIGN KEY (config_id) REFERENCES public.backup_configs(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: backup_snapshots backup_snapshots_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.backup_snapshots
    ADD CONSTRAINT backup_snapshots_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: brain_device_context brain_device_context_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.brain_device_context
    ADD CONSTRAINT brain_device_context_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: brain_device_context brain_device_context_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.brain_device_context
    ADD CONSTRAINT brain_device_context_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: browser_extensions browser_extensions_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.browser_extensions
    ADD CONSTRAINT browser_extensions_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: browser_extensions browser_extensions_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.browser_extensions
    ADD CONSTRAINT browser_extensions_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: browser_policies browser_policies_created_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.browser_policies
    ADD CONSTRAINT browser_policies_created_by_users_id_fk FOREIGN KEY (created_by) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: browser_policies browser_policies_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.browser_policies
    ADD CONSTRAINT browser_policies_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: browser_policy_violations browser_policy_violations_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.browser_policy_violations
    ADD CONSTRAINT browser_policy_violations_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: browser_policy_violations browser_policy_violations_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.browser_policy_violations
    ADD CONSTRAINT browser_policy_violations_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: browser_policy_violations browser_policy_violations_policy_id_browser_policies_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.browser_policy_violations
    ADD CONSTRAINT browser_policy_violations_policy_id_browser_policies_id_fk FOREIGN KEY (policy_id) REFERENCES public.browser_policies(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: cis_baseline_results cis_baseline_results_baseline_id_cis_baselines_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.cis_baseline_results
    ADD CONSTRAINT cis_baseline_results_baseline_id_cis_baselines_id_fk FOREIGN KEY (baseline_id) REFERENCES public.cis_baselines(id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: cis_baseline_results cis_baseline_results_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.cis_baseline_results
    ADD CONSTRAINT cis_baseline_results_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: cis_baseline_results cis_baseline_results_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.cis_baseline_results
    ADD CONSTRAINT cis_baseline_results_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: cis_baselines cis_baselines_created_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.cis_baselines
    ADD CONSTRAINT cis_baselines_created_by_users_id_fk FOREIGN KEY (created_by) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: cis_baselines cis_baselines_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.cis_baselines
    ADD CONSTRAINT cis_baselines_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: cis_remediation_actions cis_remediation_actions_approved_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.cis_remediation_actions
    ADD CONSTRAINT cis_remediation_actions_approved_by_users_id_fk FOREIGN KEY (approved_by) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: cis_remediation_actions cis_remediation_actions_baseline_id_cis_baselines_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.cis_remediation_actions
    ADD CONSTRAINT cis_remediation_actions_baseline_id_cis_baselines_id_fk FOREIGN KEY (baseline_id) REFERENCES public.cis_baselines(id) ON DELETE SET NULL;
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: cis_remediation_actions cis_remediation_actions_baseline_result_id_cis_baseline_results; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.cis_remediation_actions
    ADD CONSTRAINT cis_remediation_actions_baseline_result_id_cis_baseline_results FOREIGN KEY (baseline_result_id) REFERENCES public.cis_baseline_results(id) ON DELETE SET NULL;
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: cis_remediation_actions cis_remediation_actions_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.cis_remediation_actions
    ADD CONSTRAINT cis_remediation_actions_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: cis_remediation_actions cis_remediation_actions_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.cis_remediation_actions
    ADD CONSTRAINT cis_remediation_actions_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: cis_remediation_actions cis_remediation_actions_requested_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.cis_remediation_actions
    ADD CONSTRAINT cis_remediation_actions_requested_by_users_id_fk FOREIGN KEY (requested_by) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: config_policy_alert_rules config_policy_alert_rules_feature_link_id_config_policy_feature; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.config_policy_alert_rules
    ADD CONSTRAINT config_policy_alert_rules_feature_link_id_config_policy_feature FOREIGN KEY (feature_link_id) REFERENCES public.config_policy_feature_links(id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: config_policy_assignments config_policy_assignments_assigned_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.config_policy_assignments
    ADD CONSTRAINT config_policy_assignments_assigned_by_users_id_fk FOREIGN KEY (assigned_by) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: config_policy_assignments config_policy_assignments_config_policy_id_configuration_polici; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.config_policy_assignments
    ADD CONSTRAINT config_policy_assignments_config_policy_id_configuration_polici FOREIGN KEY (config_policy_id) REFERENCES public.configuration_policies(id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: config_policy_automations config_policy_automations_feature_link_id_config_policy_feature; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.config_policy_automations
    ADD CONSTRAINT config_policy_automations_feature_link_id_config_policy_feature FOREIGN KEY (feature_link_id) REFERENCES public.config_policy_feature_links(id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: config_policy_compliance_rules config_policy_compliance_rules_feature_link_id_config_policy_fe; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.config_policy_compliance_rules
    ADD CONSTRAINT config_policy_compliance_rules_feature_link_id_config_policy_fe FOREIGN KEY (feature_link_id) REFERENCES public.config_policy_feature_links(id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: config_policy_compliance_rules config_policy_compliance_rules_remediation_script_id_scripts_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.config_policy_compliance_rules
    ADD CONSTRAINT config_policy_compliance_rules_remediation_script_id_scripts_id FOREIGN KEY (remediation_script_id) REFERENCES public.scripts(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: config_policy_event_log_settings config_policy_event_log_settings_feature_link_id_config_policy_; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.config_policy_event_log_settings
    ADD CONSTRAINT config_policy_event_log_settings_feature_link_id_config_policy_ FOREIGN KEY (feature_link_id) REFERENCES public.config_policy_feature_links(id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: config_policy_feature_links config_policy_feature_links_config_policy_id_configuration_poli; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.config_policy_feature_links
    ADD CONSTRAINT config_policy_feature_links_config_policy_id_configuration_poli FOREIGN KEY (config_policy_id) REFERENCES public.configuration_policies(id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: config_policy_maintenance_settings config_policy_maintenance_settings_feature_link_id_config_polic; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.config_policy_maintenance_settings
    ADD CONSTRAINT config_policy_maintenance_settings_feature_link_id_config_polic FOREIGN KEY (feature_link_id) REFERENCES public.config_policy_feature_links(id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: config_policy_monitoring_settings config_policy_monitoring_settings_feature_link_id_config_policy; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.config_policy_monitoring_settings
    ADD CONSTRAINT config_policy_monitoring_settings_feature_link_id_config_policy FOREIGN KEY (feature_link_id) REFERENCES public.config_policy_feature_links(id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: config_policy_monitoring_watches config_policy_monitoring_watches_settings_id_config_policy_moni; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.config_policy_monitoring_watches
    ADD CONSTRAINT config_policy_monitoring_watches_settings_id_config_policy_moni FOREIGN KEY (settings_id) REFERENCES public.config_policy_monitoring_settings(id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: config_policy_patch_settings config_policy_patch_settings_feature_link_id_config_policy_feat; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.config_policy_patch_settings
    ADD CONSTRAINT config_policy_patch_settings_feature_link_id_config_policy_feat FOREIGN KEY (feature_link_id) REFERENCES public.config_policy_feature_links(id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: config_policy_sensitive_data_settings config_policy_sensitive_data_settings_feature_link_id_config_po; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.config_policy_sensitive_data_settings
    ADD CONSTRAINT config_policy_sensitive_data_settings_feature_link_id_config_po FOREIGN KEY (feature_link_id) REFERENCES public.config_policy_feature_links(id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: configuration_policies configuration_policies_created_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.configuration_policies
    ADD CONSTRAINT configuration_policies_created_by_users_id_fk FOREIGN KEY (created_by) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: configuration_policies configuration_policies_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.configuration_policies
    ADD CONSTRAINT configuration_policies_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: device_boot_metrics device_boot_metrics_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.device_boot_metrics
    ADD CONSTRAINT device_boot_metrics_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: device_boot_metrics device_boot_metrics_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.device_boot_metrics
    ADD CONSTRAINT device_boot_metrics_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: device_change_log device_change_log_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.device_change_log
    ADD CONSTRAINT device_change_log_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: device_change_log device_change_log_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.device_change_log
    ADD CONSTRAINT device_change_log_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: device_ip_history device_ip_history_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.device_ip_history
    ADD CONSTRAINT device_ip_history_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: device_ip_history device_ip_history_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.device_ip_history
    ADD CONSTRAINT device_ip_history_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: device_reliability device_reliability_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.device_reliability
    ADD CONSTRAINT device_reliability_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: device_reliability_history device_reliability_history_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.device_reliability_history
    ADD CONSTRAINT device_reliability_history_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: device_reliability_history device_reliability_history_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.device_reliability_history
    ADD CONSTRAINT device_reliability_history_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: device_reliability device_reliability_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.device_reliability
    ADD CONSTRAINT device_reliability_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: device_warranty device_warranty_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.device_warranty
    ADD CONSTRAINT device_warranty_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: device_warranty device_warranty_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.device_warranty
    ADD CONSTRAINT device_warranty_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: discovered_assets discovered_assets_approved_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.discovered_assets
    ADD CONSTRAINT discovered_assets_approved_by_users_id_fk FOREIGN KEY (approved_by) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: discovered_assets discovered_assets_dismissed_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.discovered_assets
    ADD CONSTRAINT discovered_assets_dismissed_by_users_id_fk FOREIGN KEY (dismissed_by) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: dns_event_aggregations dns_event_aggregations_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.dns_event_aggregations
    ADD CONSTRAINT dns_event_aggregations_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: dns_event_aggregations dns_event_aggregations_integration_id_dns_filter_integrations_i; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.dns_event_aggregations
    ADD CONSTRAINT dns_event_aggregations_integration_id_dns_filter_integrations_i FOREIGN KEY (integration_id) REFERENCES public.dns_filter_integrations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: dns_event_aggregations dns_event_aggregations_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.dns_event_aggregations
    ADD CONSTRAINT dns_event_aggregations_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: dns_filter_integrations dns_filter_integrations_created_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.dns_filter_integrations
    ADD CONSTRAINT dns_filter_integrations_created_by_users_id_fk FOREIGN KEY (created_by) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: dns_filter_integrations dns_filter_integrations_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.dns_filter_integrations
    ADD CONSTRAINT dns_filter_integrations_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: dns_policies dns_policies_created_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.dns_policies
    ADD CONSTRAINT dns_policies_created_by_users_id_fk FOREIGN KEY (created_by) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: dns_policies dns_policies_integration_id_dns_filter_integrations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.dns_policies
    ADD CONSTRAINT dns_policies_integration_id_dns_filter_integrations_id_fk FOREIGN KEY (integration_id) REFERENCES public.dns_filter_integrations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: dns_policies dns_policies_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.dns_policies
    ADD CONSTRAINT dns_policies_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: dns_security_events dns_security_events_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.dns_security_events
    ADD CONSTRAINT dns_security_events_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: dns_security_events dns_security_events_integration_id_dns_filter_integrations_id_f; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.dns_security_events
    ADD CONSTRAINT dns_security_events_integration_id_dns_filter_integrations_id_f FOREIGN KEY (integration_id) REFERENCES public.dns_filter_integrations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: dns_security_events dns_security_events_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.dns_security_events
    ADD CONSTRAINT dns_security_events_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: huntress_agents huntress_agents_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.huntress_agents
    ADD CONSTRAINT huntress_agents_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: huntress_agents huntress_agents_integration_id_huntress_integrations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.huntress_agents
    ADD CONSTRAINT huntress_agents_integration_id_huntress_integrations_id_fk FOREIGN KEY (integration_id) REFERENCES public.huntress_integrations(id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: huntress_agents huntress_agents_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.huntress_agents
    ADD CONSTRAINT huntress_agents_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: huntress_incidents huntress_incidents_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.huntress_incidents
    ADD CONSTRAINT huntress_incidents_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: huntress_incidents huntress_incidents_integration_id_huntress_integrations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.huntress_incidents
    ADD CONSTRAINT huntress_incidents_integration_id_huntress_integrations_id_fk FOREIGN KEY (integration_id) REFERENCES public.huntress_integrations(id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: huntress_incidents huntress_incidents_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.huntress_incidents
    ADD CONSTRAINT huntress_incidents_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: huntress_integrations huntress_integrations_created_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.huntress_integrations
    ADD CONSTRAINT huntress_integrations_created_by_users_id_fk FOREIGN KEY (created_by) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: huntress_integrations huntress_integrations_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.huntress_integrations
    ADD CONSTRAINT huntress_integrations_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: log_correlation_rules log_correlation_rules_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.log_correlation_rules
    ADD CONSTRAINT log_correlation_rules_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: log_correlations log_correlations_alert_id_alerts_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.log_correlations
    ADD CONSTRAINT log_correlations_alert_id_alerts_id_fk FOREIGN KEY (alert_id) REFERENCES public.alerts(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: log_correlations log_correlations_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.log_correlations
    ADD CONSTRAINT log_correlations_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: log_correlations log_correlations_resolved_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.log_correlations
    ADD CONSTRAINT log_correlations_resolved_by_users_id_fk FOREIGN KEY (resolved_by) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: log_correlations log_correlations_rule_id_log_correlation_rules_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.log_correlations
    ADD CONSTRAINT log_correlations_rule_id_log_correlation_rules_id_fk FOREIGN KEY (rule_id) REFERENCES public.log_correlation_rules(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: log_search_queries log_search_queries_created_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.log_search_queries
    ADD CONSTRAINT log_search_queries_created_by_users_id_fk FOREIGN KEY (created_by) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: log_search_queries log_search_queries_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.log_search_queries
    ADD CONSTRAINT log_search_queries_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: network_baselines network_baselines_last_scan_job_id_discovery_jobs_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.network_baselines
    ADD CONSTRAINT network_baselines_last_scan_job_id_discovery_jobs_id_fk FOREIGN KEY (last_scan_job_id) REFERENCES public.discovery_jobs(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: network_baselines network_baselines_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.network_baselines
    ADD CONSTRAINT network_baselines_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: network_baselines network_baselines_site_id_sites_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.network_baselines
    ADD CONSTRAINT network_baselines_site_id_sites_id_fk FOREIGN KEY (site_id) REFERENCES public.sites(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: network_change_events network_change_events_acknowledged_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.network_change_events
    ADD CONSTRAINT network_change_events_acknowledged_by_users_id_fk FOREIGN KEY (acknowledged_by) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: network_change_events network_change_events_alert_id_alerts_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.network_change_events
    ADD CONSTRAINT network_change_events_alert_id_alerts_id_fk FOREIGN KEY (alert_id) REFERENCES public.alerts(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: network_change_events network_change_events_baseline_id_network_baselines_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.network_change_events
    ADD CONSTRAINT network_change_events_baseline_id_network_baselines_id_fk FOREIGN KEY (baseline_id) REFERENCES public.network_baselines(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: network_change_events network_change_events_linked_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.network_change_events
    ADD CONSTRAINT network_change_events_linked_device_id_devices_id_fk FOREIGN KEY (linked_device_id) REFERENCES public.devices(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: network_change_events network_change_events_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.network_change_events
    ADD CONSTRAINT network_change_events_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: network_change_events network_change_events_profile_id_discovery_profiles_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.network_change_events
    ADD CONSTRAINT network_change_events_profile_id_discovery_profiles_id_fk FOREIGN KEY (profile_id) REFERENCES public.discovery_profiles(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: network_change_events network_change_events_site_id_sites_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.network_change_events
    ADD CONSTRAINT network_change_events_site_id_sites_id_fk FOREIGN KEY (site_id) REFERENCES public.sites(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: network_known_guests network_known_guests_added_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.network_known_guests
    ADD CONSTRAINT network_known_guests_added_by_users_id_fk FOREIGN KEY (added_by) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: network_known_guests network_known_guests_partner_id_partners_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.network_known_guests
    ADD CONSTRAINT network_known_guests_partner_id_partners_id_fk FOREIGN KEY (partner_id) REFERENCES public.partners(id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: notification_routing_rules notification_routing_rules_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.notification_routing_rules
    ADD CONSTRAINT notification_routing_rules_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: patch_approvals patch_approvals_ring_id_patch_policies_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.patch_approvals
    ADD CONSTRAINT patch_approvals_ring_id_patch_policies_id_fk FOREIGN KEY (ring_id) REFERENCES public.patch_policies(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: patch_compliance_snapshots patch_compliance_snapshots_ring_id_patch_policies_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.patch_compliance_snapshots
    ADD CONSTRAINT patch_compliance_snapshots_ring_id_patch_policies_id_fk FOREIGN KEY (ring_id) REFERENCES public.patch_policies(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: patch_jobs patch_jobs_ring_id_patch_policies_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.patch_jobs
    ADD CONSTRAINT patch_jobs_ring_id_patch_policies_id_fk FOREIGN KEY (ring_id) REFERENCES public.patch_policies(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: peripheral_events peripheral_events_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.peripheral_events
    ADD CONSTRAINT peripheral_events_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: peripheral_events peripheral_events_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.peripheral_events
    ADD CONSTRAINT peripheral_events_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: peripheral_events peripheral_events_policy_id_peripheral_policies_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.peripheral_events
    ADD CONSTRAINT peripheral_events_policy_id_peripheral_policies_id_fk FOREIGN KEY (policy_id) REFERENCES public.peripheral_policies(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: peripheral_policies peripheral_policies_created_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.peripheral_policies
    ADD CONSTRAINT peripheral_policies_created_by_users_id_fk FOREIGN KEY (created_by) REFERENCES public.users(id) ON DELETE SET NULL;
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: peripheral_policies peripheral_policies_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.peripheral_policies
    ADD CONSTRAINT peripheral_policies_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: playbook_definitions playbook_definitions_created_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.playbook_definitions
    ADD CONSTRAINT playbook_definitions_created_by_users_id_fk FOREIGN KEY (created_by) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: playbook_definitions playbook_definitions_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.playbook_definitions
    ADD CONSTRAINT playbook_definitions_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: playbook_executions playbook_executions_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.playbook_executions
    ADD CONSTRAINT playbook_executions_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: playbook_executions playbook_executions_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.playbook_executions
    ADD CONSTRAINT playbook_executions_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: playbook_executions playbook_executions_playbook_id_playbook_definitions_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.playbook_executions
    ADD CONSTRAINT playbook_executions_playbook_id_playbook_definitions_id_fk FOREIGN KEY (playbook_id) REFERENCES public.playbook_definitions(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: playbook_executions playbook_executions_triggered_by_user_id_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.playbook_executions
    ADD CONSTRAINT playbook_executions_triggered_by_user_id_users_id_fk FOREIGN KEY (triggered_by_user_id) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: restore_jobs restore_jobs_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.restore_jobs
    ADD CONSTRAINT restore_jobs_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: s1_actions s1_actions_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.s1_actions
    ADD CONSTRAINT s1_actions_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: s1_actions s1_actions_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.s1_actions
    ADD CONSTRAINT s1_actions_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: s1_actions s1_actions_requested_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.s1_actions
    ADD CONSTRAINT s1_actions_requested_by_users_id_fk FOREIGN KEY (requested_by) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: s1_agents s1_agents_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.s1_agents
    ADD CONSTRAINT s1_agents_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: s1_agents s1_agents_integration_id_s1_integrations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.s1_agents
    ADD CONSTRAINT s1_agents_integration_id_s1_integrations_id_fk FOREIGN KEY (integration_id) REFERENCES public.s1_integrations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: s1_agents s1_agents_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.s1_agents
    ADD CONSTRAINT s1_agents_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: s1_integrations s1_integrations_created_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.s1_integrations
    ADD CONSTRAINT s1_integrations_created_by_users_id_fk FOREIGN KEY (created_by) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: s1_integrations s1_integrations_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.s1_integrations
    ADD CONSTRAINT s1_integrations_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: s1_site_mappings s1_site_mappings_integration_id_s1_integrations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.s1_site_mappings
    ADD CONSTRAINT s1_site_mappings_integration_id_s1_integrations_id_fk FOREIGN KEY (integration_id) REFERENCES public.s1_integrations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: s1_site_mappings s1_site_mappings_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.s1_site_mappings
    ADD CONSTRAINT s1_site_mappings_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: s1_threats s1_threats_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.s1_threats
    ADD CONSTRAINT s1_threats_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: s1_threats s1_threats_integration_id_s1_integrations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.s1_threats
    ADD CONSTRAINT s1_threats_integration_id_s1_integrations_id_fk FOREIGN KEY (integration_id) REFERENCES public.s1_integrations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: s1_threats s1_threats_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.s1_threats
    ADD CONSTRAINT s1_threats_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: sensitive_data_findings sensitive_data_findings_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.sensitive_data_findings
    ADD CONSTRAINT sensitive_data_findings_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: sensitive_data_findings sensitive_data_findings_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.sensitive_data_findings
    ADD CONSTRAINT sensitive_data_findings_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: sensitive_data_findings sensitive_data_findings_scan_id_sensitive_data_scans_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.sensitive_data_findings
    ADD CONSTRAINT sensitive_data_findings_scan_id_sensitive_data_scans_id_fk FOREIGN KEY (scan_id) REFERENCES public.sensitive_data_scans(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: sensitive_data_policies sensitive_data_policies_created_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.sensitive_data_policies
    ADD CONSTRAINT sensitive_data_policies_created_by_users_id_fk FOREIGN KEY (created_by) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: sensitive_data_policies sensitive_data_policies_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.sensitive_data_policies
    ADD CONSTRAINT sensitive_data_policies_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: sensitive_data_scans sensitive_data_scans_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.sensitive_data_scans
    ADD CONSTRAINT sensitive_data_scans_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: sensitive_data_scans sensitive_data_scans_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.sensitive_data_scans
    ADD CONSTRAINT sensitive_data_scans_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: sensitive_data_scans sensitive_data_scans_policy_id_sensitive_data_policies_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.sensitive_data_scans
    ADD CONSTRAINT sensitive_data_scans_policy_id_sensitive_data_policies_id_fk FOREIGN KEY (policy_id) REFERENCES public.sensitive_data_policies(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: sensitive_data_scans sensitive_data_scans_requested_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.sensitive_data_scans
    ADD CONSTRAINT sensitive_data_scans_requested_by_users_id_fk FOREIGN KEY (requested_by) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: service_process_check_results service_process_check_results_device_id_devices_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.service_process_check_results
    ADD CONSTRAINT service_process_check_results_device_id_devices_id_fk FOREIGN KEY (device_id) REFERENCES public.devices(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: service_process_check_results service_process_check_results_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.service_process_check_results
    ADD CONSTRAINT service_process_check_results_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: software_catalog software_catalog_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.software_catalog
    ADD CONSTRAINT software_catalog_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: user_risk_events user_risk_events_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.user_risk_events
    ADD CONSTRAINT user_risk_events_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: user_risk_events user_risk_events_user_id_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.user_risk_events
    ADD CONSTRAINT user_risk_events_user_id_users_id_fk FOREIGN KEY (user_id) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: user_risk_policies user_risk_policies_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.user_risk_policies
    ADD CONSTRAINT user_risk_policies_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: user_risk_policies user_risk_policies_updated_by_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.user_risk_policies
    ADD CONSTRAINT user_risk_policies_updated_by_users_id_fk FOREIGN KEY (updated_by) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: user_risk_scores user_risk_scores_org_id_organizations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.user_risk_scores
    ADD CONSTRAINT user_risk_scores_org_id_organizations_id_fk FOREIGN KEY (org_id) REFERENCES public.organizations(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;


--
-- Name: user_risk_scores user_risk_scores_user_id_users_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

DO $$ BEGIN
ALTER TABLE ONLY public.user_risk_scores
    ADD CONSTRAINT user_risk_scores_user_id_users_id_fk FOREIGN KEY (user_id) REFERENCES public.users(id);
EXCEPTION WHEN duplicate_object THEN null;
END $$;
...
--
-- Name: backup_policies; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: agent_logs breeze_org_isolation_delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_delete ON public.agent_logs FOR DELETE USING (public.breeze_has_org_access(org_id));


--
-- Name: ai_action_plans breeze_org_isolation_delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_delete ON public.ai_action_plans FOR DELETE USING (public.breeze_has_org_access(org_id));
...
--
-- Name: ai_screenshots breeze_org_isolation_delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_delete ON public.ai_screenshots FOR DELETE USING (public.breeze_has_org_access(org_id));
...
--
-- Name: backup_jobs breeze_org_isolation_delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_delete ON public.backup_jobs FOR DELETE USING (public.breeze_has_org_access(org_id));


--
-- Name: backup_policies breeze_org_isolation_delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_delete ON public.backup_policies FOR DELETE USING (public.breeze_has_org_access(org_id));


--
-- Name: backup_snapshots breeze_org_isolation_delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_delete ON public.backup_snapshots FOR DELETE USING (public.breeze_has_org_access(org_id));


--
-- Name: brain_device_context breeze_org_isolation_delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_delete ON public.brain_device_context FOR DELETE USING (public.breeze_has_org_access(org_id));
...
--
-- Name: configuration_policies breeze_org_isolation_delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_delete ON public.configuration_policies FOR DELETE USING (public.breeze_has_org_access(org_id));
...
--
-- Name: device_boot_metrics breeze_org_isolation_delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_delete ON public.device_boot_metrics FOR DELETE USING (public.breeze_has_org_access(org_id));
...
--
-- Name: device_warranty breeze_org_isolation_delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_delete ON public.device_warranty FOR DELETE USING (public.breeze_has_org_access(org_id));
...
--
-- Name: notification_routing_rules breeze_org_isolation_delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_delete ON public.notification_routing_rules FOR DELETE USING (public.breeze_has_org_access(org_id));
...
--
-- Name: playbook_definitions breeze_org_isolation_delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_delete ON public.playbook_definitions FOR DELETE USING (public.breeze_has_org_access(org_id));


--
-- Name: playbook_executions breeze_org_isolation_delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_delete ON public.playbook_executions FOR DELETE USING (public.breeze_has_org_access(org_id));
...
--
-- Name: restore_jobs breeze_org_isolation_delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_delete ON public.restore_jobs FOR DELETE USING (public.breeze_has_org_access(org_id));
...
--
-- Name: sensitive_data_findings breeze_org_isolation_delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_delete ON public.sensitive_data_findings FOR DELETE USING (public.breeze_has_org_access(org_id));


--
-- Name: sensitive_data_policies breeze_org_isolation_delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_delete ON public.sensitive_data_policies FOR DELETE USING (public.breeze_has_org_access(org_id));


--
-- Name: sensitive_data_scans breeze_org_isolation_delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_delete ON public.sensitive_data_scans FOR DELETE USING (public.breeze_has_org_access(org_id));


--
-- Name: service_process_check_results breeze_org_isolation_delete; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_delete ON public.service_process_check_results FOR DELETE USING (public.breeze_has_org_access(org_id));
...
--
-- Name: agent_logs breeze_org_isolation_insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_insert ON public.agent_logs FOR INSERT WITH CHECK (public.breeze_has_org_access(org_id));


--
-- Name: ai_action_plans breeze_org_isolation_insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_insert ON public.ai_action_plans FOR INSERT WITH CHECK (public.breeze_has_org_access(org_id));
...
--
-- Name: ai_screenshots breeze_org_isolation_insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_insert ON public.ai_screenshots FOR INSERT WITH CHECK (public.breeze_has_org_access(org_id));
...
--
-- Name: backup_jobs breeze_org_isolation_insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_insert ON public.backup_jobs FOR INSERT WITH CHECK (public.breeze_has_org_access(org_id));


--
-- Name: backup_policies breeze_org_isolation_insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_insert ON public.backup_policies FOR INSERT WITH CHECK (public.breeze_has_org_access(org_id));


--
-- Name: backup_snapshots breeze_org_isolation_insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_insert ON public.backup_snapshots FOR INSERT WITH CHECK (public.breeze_has_org_access(org_id));


--
-- Name: brain_device_context breeze_org_isolation_insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_insert ON public.brain_device_context FOR INSERT WITH CHECK (public.breeze_has_org_access(org_id));
...
--
-- Name: configuration_policies breeze_org_isolation_insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_insert ON public.configuration_policies FOR INSERT WITH CHECK (public.breeze_has_org_access(org_id));
...
--
-- Name: device_boot_metrics breeze_org_isolation_insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_insert ON public.device_boot_metrics FOR INSERT WITH CHECK (public.breeze_has_org_access(org_id));
...
--
-- Name: device_warranty breeze_org_isolation_insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_insert ON public.device_warranty FOR INSERT WITH CHECK (public.breeze_has_org_access(org_id));
...
--
-- Name: notification_routing_rules breeze_org_isolation_insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_insert ON public.notification_routing_rules FOR INSERT WITH CHECK (public.breeze_has_org_access(org_id));
...
--
-- Name: playbook_definitions breeze_org_isolation_insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_insert ON public.playbook_definitions FOR INSERT WITH CHECK (public.breeze_has_org_access(org_id));


--
-- Name: playbook_executions breeze_org_isolation_insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_insert ON public.playbook_executions FOR INSERT WITH CHECK (public.breeze_has_org_access(org_id));
...
--
-- Name: restore_jobs breeze_org_isolation_insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_insert ON public.restore_jobs FOR INSERT WITH CHECK (public.breeze_has_org_access(org_id));
...
--
-- Name: sensitive_data_findings breeze_org_isolation_insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_insert ON public.sensitive_data_findings FOR INSERT WITH CHECK (public.breeze_has_org_access(org_id));


--
-- Name: sensitive_data_policies breeze_org_isolation_insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_insert ON public.sensitive_data_policies FOR INSERT WITH CHECK (public.breeze_has_org_access(org_id));


--
-- Name: sensitive_data_scans breeze_org_isolation_insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_insert ON public.sensitive_data_scans FOR INSERT WITH CHECK (public.breeze_has_org_access(org_id));


--
-- Name: service_process_check_results breeze_org_isolation_insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_insert ON public.service_process_check_results FOR INSERT WITH CHECK (public.breeze_has_org_access(org_id));
...
--
-- Name: agent_logs breeze_org_isolation_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_select ON public.agent_logs FOR SELECT USING (public.breeze_has_org_access(org_id));


--
-- Name: ai_action_plans breeze_org_isolation_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_select ON public.ai_action_plans FOR SELECT USING (public.breeze_has_org_access(org_id));
...
--
-- Name: ai_screenshots breeze_org_isolation_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_select ON public.ai_screenshots FOR SELECT USING (public.breeze_has_org_access(org_id));
...
--
-- Name: backup_jobs breeze_org_isolation_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_select ON public.backup_jobs FOR SELECT USING (public.breeze_has_org_access(org_id));


--
-- Name: backup_policies breeze_org_isolation_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_select ON public.backup_policies FOR SELECT USING (public.breeze_has_org_access(org_id));


--
-- Name: backup_snapshots breeze_org_isolation_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_select ON public.backup_snapshots FOR SELECT USING (public.breeze_has_org_access(org_id));


--
-- Name: brain_device_context breeze_org_isolation_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_select ON public.brain_device_context FOR SELECT USING (public.breeze_has_org_access(org_id));
...
--
-- Name: configuration_policies breeze_org_isolation_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_select ON public.configuration_policies FOR SELECT USING (public.breeze_has_org_access(org_id));
...
--
-- Name: device_boot_metrics breeze_org_isolation_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_select ON public.device_boot_metrics FOR SELECT USING (public.breeze_has_org_access(org_id));
...
--
-- Name: device_warranty breeze_org_isolation_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_select ON public.device_warranty FOR SELECT USING (public.breeze_has_org_access(org_id));
...
--
-- Name: notification_routing_rules breeze_org_isolation_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_select ON public.notification_routing_rules FOR SELECT USING (public.breeze_has_org_access(org_id));
...
--
-- Name: playbook_definitions breeze_org_isolation_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_select ON public.playbook_definitions FOR SELECT USING (public.breeze_has_org_access(org_id));


--
-- Name: playbook_executions breeze_org_isolation_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_select ON public.playbook_executions FOR SELECT USING (public.breeze_has_org_access(org_id));
...
--
-- Name: restore_jobs breeze_org_isolation_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_select ON public.restore_jobs FOR SELECT USING (public.breeze_has_org_access(org_id));
...
--
-- Name: sensitive_data_findings breeze_org_isolation_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_select ON public.sensitive_data_findings FOR SELECT USING (public.breeze_has_org_access(org_id));


--
-- Name: sensitive_data_policies breeze_org_isolation_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_select ON public.sensitive_data_policies FOR SELECT USING (public.breeze_has_org_access(org_id));


--
-- Name: sensitive_data_scans breeze_org_isolation_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_select ON public.sensitive_data_scans FOR SELECT USING (public.breeze_has_org_access(org_id));


--
-- Name: service_process_check_results breeze_org_isolation_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_select ON public.service_process_check_results FOR SELECT USING (public.breeze_has_org_access(org_id));
...
--
-- Name: agent_logs breeze_org_isolation_update; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_update ON public.agent_logs FOR UPDATE USING (public.breeze_has_org_access(org_id)) WITH CHECK (public.breeze_has_org_access(org_id));


--
-- Name: ai_action_plans breeze_org_isolation_update; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_update ON public.ai_action_plans FOR UPDATE USING (public.breeze_has_org_access(org_id)) WITH CHECK (public.breeze_has_org_access(org_id));
...
--
-- Name: ai_screenshots breeze_org_isolation_update; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_update ON public.ai_screenshots FOR UPDATE USING (public.breeze_has_org_access(org_id)) WITH CHECK (public.breeze_has_org_access(org_id));
...
--
-- Name: backup_jobs breeze_org_isolation_update; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_update ON public.backup_jobs FOR UPDATE USING (public.breeze_has_org_access(org_id)) WITH CHECK (public.breeze_has_org_access(org_id));


--
-- Name: backup_policies breeze_org_isolation_update; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_update ON public.backup_policies FOR UPDATE USING (public.breeze_has_org_access(org_id)) WITH CHECK (public.breeze_has_org_access(org_id));


--
-- Name: backup_snapshots breeze_org_isolation_update; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_update ON public.backup_snapshots FOR UPDATE USING (public.breeze_has_org_access(org_id)) WITH CHECK (public.breeze_has_org_access(org_id));


--
-- Name: brain_device_context breeze_org_isolation_update; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_update ON public.brain_device_context FOR UPDATE USING (public.breeze_has_org_access(org_id)) WITH CHECK (public.breeze_has_org_access(org_id));
...
--
-- Name: configuration_policies breeze_org_isolation_update; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_update ON public.configuration_policies FOR UPDATE USING (public.breeze_has_org_access(org_id)) WITH CHECK (public.breeze_has_org_access(org_id));
...
--
-- Name: device_boot_metrics breeze_org_isolation_update; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_update ON public.device_boot_metrics FOR UPDATE USING (public.breeze_has_org_access(org_id)) WITH CHECK (public.breeze_has_org_access(org_id));
...
--
-- Name: device_warranty breeze_org_isolation_update; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_update ON public.device_warranty FOR UPDATE USING (public.breeze_has_org_access(org_id)) WITH CHECK (public.breeze_has_org_access(org_id));
...
--
-- Name: notification_routing_rules breeze_org_isolation_update; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_update ON public.notification_routing_rules FOR UPDATE USING (public.breeze_has_org_access(org_id)) WITH CHECK (public.breeze_has_org_access(org_id));
...
--
-- Name: playbook_definitions breeze_org_isolation_update; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_update ON public.playbook_definitions FOR UPDATE USING (public.breeze_has_org_access(org_id)) WITH CHECK (public.breeze_has_org_access(org_id));


--
-- Name: playbook_executions breeze_org_isolation_update; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_update ON public.playbook_executions FOR UPDATE USING (public.breeze_has_org_access(org_id)) WITH CHECK (public.breeze_has_org_access(org_id));
...
--
-- Name: restore_jobs breeze_org_isolation_update; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_update ON public.restore_jobs FOR UPDATE USING (public.breeze_has_org_access(org_id)) WITH CHECK (public.breeze_has_org_access(org_id));
...
--
-- Name: sensitive_data_findings breeze_org_isolation_update; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_update ON public.sensitive_data_findings FOR UPDATE USING (public.breeze_has_org_access(org_id)) WITH CHECK (public.breeze_has_org_access(org_id));


--
-- Name: sensitive_data_policies breeze_org_isolation_update; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_update ON public.sensitive_data_policies FOR UPDATE USING (public.breeze_has_org_access(org_id)) WITH CHECK (public.breeze_has_org_access(org_id));


--
-- Name: sensitive_data_scans breeze_org_isolation_update; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_update ON public.sensitive_data_scans FOR UPDATE USING (public.breeze_has_org_access(org_id)) WITH CHECK (public.breeze_has_org_access(org_id));


--
-- Name: service_process_check_results breeze_org_isolation_update; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY breeze_org_isolation_update ON public.service_process_check_results FOR UPDATE USING (public.breeze_has_org_access(org_id)) WITH CHECK (public.breeze_has_org_access(org_id));
...
--
-- Name: device_warranty; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.device_warranty ENABLE ROW LEVEL SECURITY;
...
--
-- Name: notification_routing_rules; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: restore_jobs; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: service_process_check_results; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.service_process_check_results ENABLE ROW LEVEL SECURITY;
