...
import { TIER3_FOUR_EYES_ACTIONS, TIER3_FOUR_EYES_TOOLS } from '../services/aiGuardrails';
...
describe('durable release: four_eyes tools must not be session_required', () => {
  const fourEyesTools = Array.from(
    new Set<string>([...TIER3_FOUR_EYES_TOOLS, ...Object.keys(TIER3_FOUR_EYES_ACTIONS)]),
  );
