...
export const CORE_TENANT_EXPORT_POLICY: TenantExportPolicyRegistry = {
  ...
  "time_entries": tablePolicy("org_id", {"included":["id","partner_id","org_id","ticket_id","user_id","started_at","ended_at","duration_minutes","description","is_billable","hourly_rate","currency_code","billing_status","work_type_id","billing_profile_id","coverage","billing_overridden","minimum_minutes","rounding_increment_minutes","source","is_approved","approved_by","approved_at","created_at","updated_at"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":[]}),
