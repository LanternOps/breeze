...
export const CORE_TENANT_EXPORT_POLICY: TenantExportPolicyRegistry = {
  ...
  "topology_diagnostic_runs": tablePolicy("org_id", {"included":["id","org_id","site_id","recipe_id","recipe_version","requester_id","subject_node_id","subject_relationship_id","subject_target_id","origin_node_id","plan_digest","idempotency_key","attempt_id","command_id","state","assessment","coverage","queued_at","started_at","queue_deadline","deadline","finished_at","cancel_requested_at","failure_reason","created_at","updated_at"],"reviewedIncluded":["body_hash"],"excludedSensitive":[],"excludedOpen":["origin_snapshot","plan","reasons","requester_authority"]}),
