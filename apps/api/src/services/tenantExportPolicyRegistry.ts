...
export const CORE_TENANT_EXPORT_POLICY: TenantExportPolicyRegistry = {
  ...
  "device_memory_modules": tablePolicy("org_id", {"included":["id","device_id","org_id","slot_key","slot_index","locator","bank_label","populated","capacity_mb","memory_type","form_factor","speed_mts","configured_speed_mts","manufacturer","part_number","serial_number","updated_at"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":[]}),
