...
export const CORE_TENANT_EXPORT_POLICY: TenantExportPolicyRegistry = {
  ...
  "notification_channels": tablePolicy("org_id", {"included":["id","org_id","partner_id","name","type","enabled","last_tested_at","last_test_status","last_test_error","throttle_max_per_window","throttle_window_seconds","created_at","updated_at"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":["templates"]}),
