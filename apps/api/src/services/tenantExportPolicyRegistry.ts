...
export const CORE_TENANT_EXPORT_POLICY: TenantExportPolicyRegistry = {
  ...
  "topology_probe_targets": tablePolicy("org_id", {"included":["id","org_id","site_id","key","revision","label","kind","enabled","created_by","updated_by","deleted_at","created_at","updated_at"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":["definition"]}),
  "topology_monitoring_policies": tablePolicy("org_id", {"included":["id","org_id","site_id","key","revision","enabled","subject_node_id","subject_relationship_id","requester_id","authority_generation","authority_digest","activation_intent","last_scheduled_at","next_scheduled_at","blocked_reason","deleted_at","created_at","updated_at"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":["definition"]}),
