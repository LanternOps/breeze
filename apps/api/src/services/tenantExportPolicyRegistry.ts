...
export const CORE_TENANT_EXPORT_POLICY: TenantExportPolicyRegistry = {
  ...
  "automation_action_results": tablePolicy("org_id", {"included":["id","run_id","device_id","org_id","action_index","action_type","status","terminal_source","command_id","script_execution_id","deployment_result_id","agent_run_id","message","output","error","completed_at","created_at","updated_at"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":[]}),
  ...
  "deliverable_template_items": tablePolicy("org_id", {"included":["id","set_id","org_id","partner_id","name","description","cadence","lead_days","grace_days","artifact_required","completion_mode","sort_order","auto_evidence_report_type","created_at","updated_at"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":[]}),
