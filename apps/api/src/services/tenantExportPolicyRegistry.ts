...
export const CORE_TENANT_EXPORT_POLICY: TenantExportPolicyRegistry = {
  ...
  "ai_agent_runs": tablePolicy("org_id", {"included":["id","agent_id","org_id","device_id","alert_id","profile","correlation_group_id","schedule_id","report_run_id","session_id","ticket_id","anomaly_incident_id","trigger_kind","trigger_event_id","dedupe_key","mode_at_start","status","summary","intent_ids","turn_count","cost_cents","error_code","correlation_id","queued_at","started_at","finished_at","task_id","task_step_key","task_attempt_ordinal","prompt_version","resolved_model"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":["trigger_ref","policy_snapshot","outcome"]}),
  ...
  "automation_action_results": tablePolicy("org_id", {"included":["id","run_id","device_id","org_id","action_index","action_type","status","terminal_source","command_id","script_execution_id","deployment_result_id","message","output","error","completed_at","created_at","updated_at"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":[]}),
  ...
  "network_monitors": tablePolicy("org_id", {"included":["id","org_id","asset_id","name","monitor_type","target","polling_interval","timeout","is_active","last_checked","last_status","last_response_ms","last_error","consecutive_failures","created_at","updated_at"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":["config"]}),
  ...
  "portal_branding": tablePolicy("org_id", {"included":["id","org_id","logo_url","favicon_url","primary_color","secondary_color","accent_color","custom_domain","domain_verified","welcome_message","support_email","support_phone","footer_text","custom_css","enable_tickets","enable_asset_checkout","enable_self_service","created_at","updated_at","enable_dashboard","enable_security","enable_backups","enable_reports","enable_support_usage","enable_service","enable_documents"],"reviewedIncluded":["enable_password_reset"],"excludedSensitive":[],"excludedOpen":[]}),
