...
export const CORE_TENANT_EXPORT_POLICY: TenantExportPolicyRegistry = {
  ...
  "alerts": tablePolicy("org_id", {"included":["topology_site_id","topology_source_key","id","rule_id","device_id","org_id","config_policy_id","config_item_name","status","severity","title","message","triggered_at","acknowledged_at","acknowledged_by","resolved_at","resolved_by","resolution_note","suppressed_until","dismissed_at","dismissed_by","created_at","monitor_id","episode_id","requires_human","subject_key","partner_feed_xid"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":["context"]}),
  ...
  "device_hardware_components": tablePolicy("org_id", {"included":["id","device_id","org_id","component_key","component_type","parent_key","source","name","model","serial","firmware","size_bytes","health","state","state_detail","progress_percent","temperature_c","predictive_failure","alert_exempt","unhealthy_streak","critical_streak","healthy_streak","below_critical_streak","predictive_streak","stale","stale_since","first_seen_at","last_seen_at","created_at","updated_at"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":["attributes"]}),
  "device_hardware_events": tablePolicy("org_id", {"included":["id","device_id","org_id","component_key","component_type","event_type","from_health","to_health","from_state","to_state","snapshot_id","occurred_at","created_at"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":["detail"]}),
  "device_hardware_health": tablePolicy("org_id", {"included":["device_id","org_id","health","collector_health","last_agent_sequence","last_snapshot_id","last_collected_at","last_received_at","last_raid_received_at","last_disk_received_at","poll_interval_minutes","disk_health_interval_minutes","tiers_run","agent_version","created_at","updated_at"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":["summary","sources"]}),
  ...
  "discovery_jobs": tablePolicy("org_id", {"included":["id","profile_id","org_id","site_id","agent_id","status","scheduled_at","started_at","completed_at","hosts_scanned","hosts_discovered","new_assets","topology_deadline_at","topology_config_generation","created_at","updated_at"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":["errors","topology_dispatch"]}),
  ...
  // W03 Task 12 (#6859): lease_token authorizes outbox ownership checks and
  // is credential-like — excludedSensitive, never included/reviewedIncluded.
  ...
  // ticket_label (sweep C4): the "Ticket #…" text frozen at issue — a plain
  // varchar ticket number, customer-visible on the document. Ordinary data.
  // ticket_subject / ticket_category (#6955): the group-header text frozen at
  // issue — plain varchar, customer-visible on the document. Ordinary data.
  "invoice_lines": tablePolicy("org_id", {"included":["id","invoice_id","org_id","source_type","source_id","source_contract_id","catalog_item_id","parent_line_id","ticket_id","ticket_label","ticket_subject","ticket_category","name","description","quantity","unit_price","cost_basis","revenue_allocation","taxable","customer_visible","line_total","is_unapproved_time","worked_minutes","sort_order","created_at"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":[]}),
  ...
  // document_theme / document_page_size (#6227): issue-time presentation
  // snapshot, scalar CHECK-constrained enums (classic|condensed, letter|a4) —
  // ordinary document data, included.
  "invoices": tablePolicy("org_id", {"included":["id","partner_id","org_id","site_id","invoice_number","status","currency_code","document_locale","document_theme","document_page_size","device_appendix","evidence_version","issue_date","due_date","subtotal","tax_rate","tax_total","total","amount_paid","balance","deposit_due","bill_to_name","bill_to_tax_id","bill_to_tax_exempt","notes","terms","terms_and_conditions","sent_at","first_viewed_at","viewed_at","paid_at","marked_overdue_at","voided_at","void_reason","replaces_invoice_id","replaced_by_invoice_id","pdf_document_ref","pdf_sha256","created_by","created_at","updated_at","public_link_expires_at"],"reviewedIncluded":[],"excludedSensitive":["public_link_token_hash","public_link_token_ct"],"excludedOpen":["bill_to_address","seller_snapshot"]}),
  "legacy_labour_pricing_archive": tablePolicy("org_id", {"included":["id","partner_id","org_id","source_table","source_id","source_name","default_billable","default_hourly_rate","rate_currency","owner_currency_code","skip_reason","archived_at"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":[]}),
  ...
  "monitor_conversions": tablePolicy("org_id", {"included":["id","org_id","partner_id","source_table","source_id","policy_id","converted_by","converted_at","reverted_at","created_at"],"reviewedIncluded":["preview_hash"],"excludedSensitive":[],"excludedOpen":["source_state","network_source_snapshot"]}),
  ...
  "org_ticket_settings": tablePolicy("org_id", {"included":["id","org_id","created_at","updated_at"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":["sla_overrides"]}),
  ...
  "topology_monitoring_policies": tablePolicy("org_id", {"included":["partner_version_id","org_version_id","configuration_digest","id","org_id","site_id","key","revision","enabled","subject_node_id","subject_relationship_id","requester_id","authority_generation","authority_digest","activation_intent","last_scheduled_at","next_scheduled_at","blocked_reason","deleted_at","created_at","updated_at","authority_permission_version","armed_at","alert_state_revision"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":["definition","authority_actor","routing_contexts","alert_state"]}),
  "topology_telemetry_arms": tablePolicy("org_id", {"included":["id","org_id","site_id","producer_kind","target_node_id","collector_device_id","authority_key","target_address","interval_seconds","state","blocked_reason","generation","armed_by","authority_permission_version","effect_digest","armed_at","expires_at","revoked_at","revoked_by","next_poll_at","last_polled_at","poll_sequence","created_at","updated_at"],"reviewedIncluded":["credential_profile_id","credential_digest"],"excludedSensitive":[],"excludedOpen":["interfaces","authority_actor"]}),
  ...
  "topology_diagnostic_runs": tablePolicy("org_id", {"included":["policy_id","policy_revision","scheduled_context_key","scheduled_family","scheduled_for","occurrence_key","continuity_key","id","org_id","site_id","recipe_id","recipe_version","requester_id","subject_node_id","subject_relationship_id","subject_target_id","origin_node_id","plan_digest","idempotency_key","attempt_id","command_id","state","assessment","coverage","queued_at","started_at","queue_deadline","deadline","finished_at","cancel_requested_at","failure_reason","created_at","updated_at"],"reviewedIncluded":["body_hash"],"excludedSensitive":[],"excludedOpen":["origin_snapshot","plan","reasons","requester_authority"]}),
  ...
  "topology_site_state": tablePolicy("org_id", {"included":["org_id","site_id","dirty_revision","materialized_input_revision","graph_revision","health_revision","build_fence","settings_revision","identity_revision","resolved_identity_revision","settings_digest","last_build_status","last_build_at","created_at","updated_at"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":["effective_settings","disabled_source_reasons"]}),
  ...
  "topology_collection_sources": tablePolicy("org_id", {"included":["id","org_id","site_id","producer_id","producer_kind","producer_epoch","epoch_issued_at","configuration_revision","protocol","context_key","address_family","accepted_sequence","materialized_sequence","confirmed_sequence","digest_version","base_snapshot_id","first_baseline_at","last_full_validation_at","confirmed_through_at","fresh_until","expected_interval_seconds","last_outcome","last_received_at","admission_refill_at","quota_rejected_count","revoked_at","created_at","updated_at","telemetry_window_started_at","telemetry_window_samples","telemetry_window_bytes","telemetry_rollup_dirty_from"],"reviewedIncluded":["content_digest","published_digest","admission_tokens"],"excludedSensitive":[],"excludedOpen":["current_baseline","published_baseline","pending_misses","retry_candidate"]}),
  // M3 interface samples (partitioned parent; leaves inherit this review).
  // Scalars are measurement identity/bookkeeping; `readings` is jsonb, so
  // excludedOpen by rule even though it holds only counters and port state.
  "topology_interface_samples": tablePolicy("org_id", {"included":["org_id","site_id","interface_id","interface_epoch","source_id","producer_epoch","source_sequence","sampled_at","resolution","valid_duration_ms","sample_count","gap_duration_ms","updated_at"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":["readings"]}),
  "topology_interfaces": tablePolicy("org_id", {"included":["id","org_id","site_id","owner_node_id","interface_key","epoch","kind","role","name","alias","os_index","controller_port_key","parent_interface_id","phys_address","retired_at","last_observed_at","last_outcome","created_at","updated_at"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":["addresses"]}),
  ...
  // topology_view_exclusions (M2 Task 7): scalar-only reversible view hides;
  // reason is operator-authored free text, actors are bare user uuids.
  "topology_view_exclusions": tablePolicy("org_id", {"included":["id","org_id","site_id","relationship_id","view","reason","created_by","revoked_at","revoked_by","created_at","updated_at"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":[]}),
  ...
  "unifi_collectors": tablePolicy("org_id", {"included":["id","integration_id","org_id","site_id","unifi_host_id","collector_device_id","controller_url","is_enabled","poll_interval_seconds","status","firmware_ok","last_poll_at","last_poll_status","last_poll_error","topology_generation","created_by","created_at","updated_at"],"reviewedIncluded":[],"excludedSensitive":["local_api_key_encrypted"],"excludedOpen":[]}),
  "unifi_controller_sites": tablePolicy("org_id", {"included":["id","collector_id","org_id","local_site_id","name","last_seen_at","topology_coverage_reason","topology_coverage_at","created_at","updated_at"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":[]}),
  ...
  "unifi_site_mappings": tablePolicy("org_id", {"included":["id","integration_id","org_id","site_id","unifi_host_id","unifi_site_id","unifi_host_name","unifi_site_name","wan_metrics_at","topology_generation","created_at","updated_at"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":["wan_metrics"]}),
