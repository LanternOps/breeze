...
describe('alert correlation RCA evidence builder', () => {
  ...
  it('builds bounded evidence and likely-cause candidates for grouped alerts', async () => {
    const result = await buildAlertCorrelationRca({
      ...
      maxEvidenceItems: 20,
      alerts: [
        { id: ALERT_1, orgId: ORG_ID, deviceId: DEVICE_ID, ruleId: 'rule-1', configPolicyId: null, configItemName: null, status: 'active', severity: 'critical', title: 'CPU high', message: 'CPU over 90%', context: { threshold: 90, observed: 96, partnerFeedXid: '1' }, triggeredAt: new Date('2026-06-18T12:00:00Z'), acknowledgedAt: null, acknowledgedBy: null, resolvedAt: null, resolvedBy: null, resolutionNote: null, suppressedUntil: null, dismissedAt: null, dismissedBy: null, monitorId: null, episodeId: null, requiresHuman: false, subjectKey: null, createdAt: new Date('2026-06-18T12:00:00Z') },
        { id: ALERT_2, orgId: ORG_ID, deviceId: DEVICE_ID, ruleId: null, configPolicyId: 'cpar-1', configItemName: 'ram_percent', status: 'active', severity: 'high', title: 'Memory high', message: 'RAM over 90%', context: { threshold: 90, observed: 94, partnerFeedXid: '1' }, triggeredAt: new Date('2026-06-18T12:02:00Z'), acknowledgedAt: null, acknowledgedBy: null, resolvedAt: null, resolvedBy: null, resolutionNote: null, suppressedUntil: null, dismissedAt: null, dismissedBy: null, monitorId: null, episodeId: null, requiresHuman: false, subjectKey: null, createdAt: new Date('2026-06-18T12:02:00Z') },
      ],
    });
  ...
  it('caps RCA evidence windows relative to old incident time instead of now', async () => {
    ...
    const result = await buildAlertCorrelationRca({
      ...
      maxEvidenceItems: 20,
      alerts: [
        { id: ALERT_1, orgId: ORG_ID, deviceId: DEVICE_ID, ruleId: 'rule-1', configPolicyId: null, configItemName: null, status: 'active', severity: 'critical', title: 'CPU high', message: 'CPU over 90%', context: {}, triggeredAt: new Date('2026-01-15T12:00:00Z'), acknowledgedAt: null, acknowledgedBy: null, resolvedAt: null, resolvedBy: null, resolutionNote: null, suppressedUntil: null, dismissedAt: null, dismissedBy: null, monitorId: null, episodeId: null, requiresHuman: false, subjectKey: null, createdAt: new Date('2026-01-15T12:00:00Z'), partnerFeedXid: '1' },
      ],
    });
