...
vi.mock('../db/schema', () => ({
  ...
  deviceMetrics: {},
  deviceBootMetrics: {},
  discoveredAssetTypeEnum: { enumValues: ['unknown', 'workstation', 'server', 'network', 'iot'] },
  dnsActionEnum: { enumValues: ['allowed', 'blocked', 'redirected'] },
  dnsThreatCategoryEnum: { enumValues: ['unknown', 'phishing', 'malware'] },
  alerts: {},
  sites: {},
  organizations: {},
  auditLogs: {},
