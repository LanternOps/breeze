...
export const RESOURCE_CLASSIFICATION: Record<PartnerExportResource, ResourceClassification> = {
  ...
  // Alert rows are generated by rules/monitors; titles and messages come from
  // operator-authored templates and can echo configured targets, so the
  // structural layer runs on those two fields only.
  alerts: {
    default: 'machine-observed',
    exceptions: {
      title: 'customer-authored',
