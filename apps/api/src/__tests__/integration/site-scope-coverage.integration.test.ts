...
const SITE_SCOPE_EXEMPT_HANDLERS: ReadonlySet<string> = new Set<string>([
  ...
  'routes/systemTools/fileBrowser.ts:GET /devices/:deviceId/files',
  'routes/systemTools/fileBrowser.ts:GET /devices/:deviceId/files/download',
  'routes/systemTools/fileBrowser.ts:GET /devices/:deviceId/files/drives',
  'routes/systemTools/fileBrowser.ts:GET /devices/:deviceId/files/trash',
  'routes/systemTools/fileBrowser.ts:POST /devices/:deviceId/files/copy',
  'routes/systemTools/fileBrowser.ts:POST /devices/:deviceId/files/delete',
  'routes/systemTools/fileBrowser.ts:POST /devices/:deviceId/files/move',
  'routes/systemTools/fileBrowser.ts:POST /devices/:deviceId/files/trash/purge',
  'routes/systemTools/fileBrowser.ts:POST /devices/:deviceId/files/trash/restore',
  'routes/systemTools/fileBrowser.ts:POST /devices/:deviceId/files/upload',
