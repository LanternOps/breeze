...
VALUES
  ('00000000-0000-4000-8000-000000000001', 'CPU High', 'CPU usage over 90% for 5 minutes', 'Performance',
   ...
   false, 15, true),
  ('00000000-0000-4000-8000-000000000002', 'Disk Space Low', 'Disk free space under 10% for 10 minutes', 'Capacity',
  ...
  ('00000000-0000-4000-8000-000000000003', 'Service Stopped', 'Critical service is stopped or not responding', 'Availability',
   ...
   '{"scope":"organization"}'::jsonb,
   false, 5, true),
  ('00000000-0000-4000-8000-000000000004', 'Memory Pressure', 'Available memory below 15% for 5 minutes', 'Performance',
