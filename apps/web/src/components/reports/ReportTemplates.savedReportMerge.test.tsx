...
describe('ReportTemplates — saved reports merged into curated cards', () => {
  ...
  it('renders a separate card per saved report when several share a curated name', async () => {
    ...
    // Total template count grows by one: 6 curated cards (#5784 W03 added the
    // Intune endpoint-management card), with the hardware-lifecycle slot
    // expanded from 1 card to 2.
