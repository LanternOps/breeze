...
// Inbound email settings + queue are a partner-scoped surface. The mailbox card
// adds its own fine-grained ticket_mailbox permission gate below; every route
// remains authoritative server-side.
