              ...
              <div className="grid gap-4 sm:grid-cols-3">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    step={512}
                    value={memoryMB}
                    onChange={(e) => setMemoryMB(Number(e.target.value) || 4096)}
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    max={64}
                    value={cpuCount}
                    onChange={(e) => setCpuCount(Number(e.target.value) || 2)}
                    className="w-full rounded-md border bg-background px-3 py-2 text-sm"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    min={10}
                    value={diskGB}
                    onChange={(e) => setDiskGB(Number(e.target.value) || 80)}
                    className="w-full rounded-md border bg-background px-3 py-2 text-sm"
                  />
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-3 md:grid-cols-2">
                <div className="rounded-md border border-dashed bg-muted/30 p-4">
                  ...
                  <p className="mt-2 text-xs text-muted-foreground">
                    {selectedSnapshot?.label ?? 'None selected'}
                  </p>
                </div>
                <div className="rounded-md border border-dashed bg-muted/30 p-4">
                  <div className="flex items-center gap-2 text-sm font-semibold text-foreground">
                  ...
                  <p className="mt-2 text-xs text-muted-foreground">
                    {selectedDevice?.hostname ?? 'None selected'}
                  </p>
                </div>
                <div className="rounded-md border border-dashed bg-muted/30 p-4">
                  <div className="flex items-center gap-2 text-sm font-semibold text-foreground">
