...
const eventOptions = [
  ...
  { value: 'alert.triggered', label: 'Alert Triggered', description: 'Triggered when an alert fires.' },
  ...
  { value: 'report.ready', label: 'Report Ready', description: 'Triggered when a report is generated.' }
];
