  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <a href="/remote/quick-support" data-testid="remote-quick-support-card" className="rounded-lg border bg-card p-6 transition-colors hover:bg-muted/50">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-semibold">{t('remoteAccessPage.quickSupport.title')}</h3>
              <p className="text-sm text-muted-foreground">{t('remoteAccessPage.quickSupport.description')}</p>
            </div>
          </div>
        </a>
      </div>
