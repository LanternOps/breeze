...
// PlatformError represents an unsupported platform operation.
...
// GetDefenderStatus returns an unsupported error on non-Windows platforms.
func GetDefenderStatus() (DefenderStatus, error) {
	return DefenderStatus{}, newPlatformError("GetDefenderStatus")
}

// TriggerDefenderScan returns an unsupported error on non-Windows platforms.
